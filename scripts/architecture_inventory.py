...
def render(inv: dict) -> str:
    ...
    a("")
    a("> Generated by `scripts/architecture_inventory.py`. Every table below is read from the")
    a("> artifact that owns the population — the check registry, the gate roster, the plugin")
    a("> manifest, the AST of the graph builder. **Do not edit this file**: run")
