...
CI_MIN_CHECKS_RUN: int = 80  # 2026-08-14: +1 (notebook_markdown_retracted_claims — the
                             #   markdown-cell half of a bundle notebook's claim surface,
                             #   which a re-execution gate is structurally blind to;
                             #   D11 finding 1951:5.2b). Not CI_SKIP.
                             # 2026-08-15: +1 (review_verify_is_one_command — rule 4 of
                             ...
                             #   to 79 the same day, so this -1 lands on 79, not on P1's 78.
                             #   Re-measure the live value; never re-derive it from the plan.
                             # 2026-08-13: +1 (existential_witness_disclosure — the
                             ...
                             #   PROMOTED out of graph_integrity, not new)  # 2026-08-10: +1 (theorem_census_agrees — the
                             #   anti-whack-a-mole census guard); 80 registered
                             #   minus 4 CI_SKIP. Previously 75 = 79 minus the
                             #   same 4 (bundle_sentence_length, TODO-D7).
