...
|---|---|---|---|---|
| `D11_initial_draft` | §1–§N | (unspecified) | (see mapping) | (missing) |
...
- Re-run `scripts/bundle_source_manifest.py --bundle D11` after any change to `docs/PAPER_DRAFT_MAPPING.md` affecting this bundle.
