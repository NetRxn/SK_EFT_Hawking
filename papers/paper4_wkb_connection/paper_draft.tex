...
\delta x_\text{imag} = \frac{\Gamma_H}{\kappa\, c_s}\,,
...
frequency dependence of~$\Gamma_H$.
...
but the WKB action integral along the anti-Stokes line acquires an
additional imaginary contribution proportional to $\delta x_\text{imag}$.

\subsection{Modified Bogoliubov coefficients}

The WKB matching across the shifted turning point yields the exact
connection formula
\begin{equation}
...
Combined with the existing formalizations (WKBAnalysis.lean, ThirdOrderSK.lean,
GaugeErasure.lean), the project now contains 89 Lean theorems
(40 Aristotle + 49 manual), all sorry-free.
