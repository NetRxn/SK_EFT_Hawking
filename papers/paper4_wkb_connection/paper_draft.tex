...
$\delta_\text{diss}(T_H)$ & $6.2\times10^{-7}$ & $4.1\times10^{-5}$ & $3.7\times10^{-7}$ \\
$\delta_k(T_H)$ & $1.2\times10^{-6}$ & $8.3\times10^{-5}$ & $7.4\times10^{-7}$ \\
$n_\text{noise}(T_H)$ & $6.2\times10^{-7}$ & $4.1\times10^{-5}$ & $3.7\times10^{-7}$ \\
...
Combined with the full project formalization across 66 Lean modules,
the project contains 968 theorems with zero axioms
(273 Aristotle-proved across 33+ runs, remainder manual), all sorry-free.
