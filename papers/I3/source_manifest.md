...
|---|---|---|---|---|
| `_phase6o_W3b_lean_only` | §1-§7 | (unspecified) | (see mapping) | (missing) |
...
- Re-run `scripts/bundle_source_manifest.py --bundle I3` after any change to `docs/PAPER_DRAFT_MAPPING.md` affecting this bundle.
