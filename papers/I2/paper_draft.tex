...
Coq/Rocq \texttt{UniMath}, Agda \texttt{categories}, Coq's
\texttt{Math-Components} as of 2026-04-30),
...
The cumulative count is approximately 161 declarations
...
$\sim$+3 above this baseline. The decidability structure is
...
specific universality theorem itself is not yet shipped as a
single named theorem in \texttt{FibonacciBraiding.lean}; it is
a downstream consequence of the shipped infrastructure plus a
density argument we have not yet formalized). A formally verified
...
scope. To the best of our knowledge after the prior-art search
documented in the SK--EFT Hawking project's
