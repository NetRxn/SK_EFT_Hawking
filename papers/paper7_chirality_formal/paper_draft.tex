...
\caption{Theorem counts per Phase~5 Lean module. Blue: manual proofs.
  ...
  project total to 588 theorems + 2 axioms.}
...
\mathrm{Rep}(D(G))$. Together, these 588 theorems across 38 modules
...
588 theorems + 2 axioms across 38 modules, 233 proved by the Aristotle
