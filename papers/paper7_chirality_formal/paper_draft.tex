...
anomaly classification, totaling 900~theorems + 2~axioms across 58~modules.
\end{abstract}
...
GoltermanShamir & 14+1ax & 7 & 9 conditions, Fock space finite \\
TPFEvasion & 12 & 0 & Master synthesis \\
\hline
Total & 54+1ax & 14 & Zero sorry \\
\hline
\end{tabular}
...
\caption{Theorem counts per Phase~5 Lean module. Blue: manual proofs.
  ...
  The full Phase~5 adds 372 theorems across 22 modules, bringing the
  project total to 900 theorems + 2 axioms.}
...
\mathrm{Rep}(D(G))$. Together, these 900 theorems across 58 modules
...
54 theorems + 1 axiom across three Lean~4 modules, with zero
...
900 theorems + 2 axioms across 58 modules, 254 proved by the Aristotle
automated theorem prover across 32+ runs, all with zero \texttt{sorry}
(main modules).
