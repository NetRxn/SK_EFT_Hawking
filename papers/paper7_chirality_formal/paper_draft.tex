...
anomaly classification, totaling 748~theorems across 49~modules.
\end{abstract}
...
\caption{Theorem counts per Phase~5 Lean module. Blue: manual proofs.
  ...
  project total to 748 theorems + 3 axioms.}
...
\mathrm{Rep}(D(G))$. Together, these 748 theorems across 49 modules
...
748 theorems + 3 axioms across 49 modules, 252 proved by the Aristotle
automated theorem prover across 30+ runs, all with zero \texttt{sorry}.
