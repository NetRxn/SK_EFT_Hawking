...
anomaly classification, totaling 2237+~theorems (1~axiom: gapped interface) across 170~modules.
\end{abstract}
...
\caption{Theorem counts per Phase~5 Lean module. Blue: manual proofs.
  ...
  The full project totals 4049 theorems (1~axiom) across 170 modules.}
...
2237+ theorems (1~axiom: gapped interface conjecture) across 170 modules,
