...
anomaly classification, totaling 2237+~theorems (1~axiom: gapped interface) across 130~modules.
\end{abstract}
...
\caption{Theorem counts per Phase~5 Lean module. Blue: manual proofs.
  ...
  The full project totals 968 theorems (zero axioms) across 66 modules.}
...
\mathrm{Rep}(D(G))$. Together, these 968 theorems across 66 modules
...
2237+ theorems (1~axiom: gapped interface conjecture) across 130 modules,
