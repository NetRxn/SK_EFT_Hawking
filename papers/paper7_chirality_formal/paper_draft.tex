...
anomaly classification, totaling 968~theorems (zero axioms) across 66~modules.
\end{abstract}
...
968 theorems (zero axioms) across 66 modules, 273 proved by the Aristotle
automated theorem prover across 33+ runs.
