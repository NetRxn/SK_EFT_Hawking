...
\item All structural results are formally verified in Lean~4.
  ...
  (18 theorems, zero \texttt{sorry}), including the phase hierarchy
  ordering, EP violation structure, and metric DOF counting.
  Three of these theorems were proved by the Aristotle automated
  theorem prover (run \texttt{b1ea2eb7}); the remainder were proved manually.
  The full project contains 216 theorems + 1 axiom across 16 modules.
\end{enumerate}
