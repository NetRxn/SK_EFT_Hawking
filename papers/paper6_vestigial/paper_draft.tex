...
Diakonov2011,Wetterich2004} demonstrates that the tetrad can arise as a
...
field~\cite{VladimirovDiakonov2012}, one obtains an action quadratic in
...
We have performed four additional analyses to quantify the limitations
...
\item All structural results are formally verified in Lean~4.
  ...
  (25 theorems) and \texttt{FermionBag4D.lean} (16 theorems), both
  with zero \texttt{sorry}. The full project contains 4049 theorems
  (1 axiom, since retired into the tracked Prop
  \texttt{TPFConjecture}) across 170 modules, 322 proved by the Aristotle automated
  theorem prover~\cite{Aristotle} across 44 runs.
\end{enumerate}
...
Structural results formalized in Lean~4 (v\leantoolchain) with Mathlib.
...
\bibitem{Wetterich2004} C.~Wetterich,
