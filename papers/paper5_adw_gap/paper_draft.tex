...
All structural theorems are formally verified with zero \texttt{sorry}.
\end{abstract}
...
tetrad, potentially circumventing some obstacles. This motivates a
Level~1 analysis as the next step.
