...
identify five structural obstacles---a ${\sim}6{,}000\times$ perturbative coupling
...
\texttt{TetradGapEquation.lean} (20 theorems, zero \texttt{sorry}; 9 proved
...
(\texttt{gap\_solution\_bounded}) disproved by automated counterexample.
\end{abstract}
...
across three modules: \texttt{ADWMechanism.lean} (21 theorems, zero
\texttt{sorry}), \texttt{TetradGapEquation.lean} (20 theorems, 1 \texttt{sorry}),
and \texttt{EmergentGravityBounds.lean} (14 theorems, 1 \texttt{sorry}).
...
\item \texttt{gap\_solution\_bounded}: \textbf{disproved} (counterexample)
\end{itemize}
...
verified both numerically and formally (41 theorems across two Lean modules,
zero \texttt{sorry}).

However, the emergent fermion bootstrap at Level~2 faces five structural
