...
across two modules: \texttt{ADWMechanism.lean} (21 theorems, zero
\texttt{sorry}) and \texttt{TetradGapEquation.lean} (20 theorems, zero
\texttt{sorry}). Both verified by \texttt{lake build} (zero \texttt{sorry},
zero errors). 9 gap equation theorems proved by Aristotle automated prover
(run \texttt{79e07d55}); 1 disproved by counterexample.
...
tetrad, potentially circumventing some obstacles. Monte Carlo simulations
