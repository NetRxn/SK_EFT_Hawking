...
All structural results are formalized in Lean~4 (v4.29.0) with Mathlib
(\texttt{8850ed93}), across three modules: \texttt{ADWMechanism.lean}
...
in the ADW mechanism---the first such derivation in the published literature.
