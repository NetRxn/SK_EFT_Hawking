...
of the ADW model require the full SO(4) Weingarten multi-channel bond
coupling (fundamental + adjoint representation channels) to produce
physically correct inter-site correlations. Production-scale simulations
with the Weingarten coupling are in progress (Paper~6).
