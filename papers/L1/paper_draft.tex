...
We formalize this caveat directly as the disjointness theorem
...
the present framework; at the project's current conservative upper
bound $|\gamma| \leq 10^{-30}$ on $\Gamma_H/\cGW^2$ it does not lift
the falsification, but a derivation of $\Gamma_H$ from a microscopic
matching is open.
\end{enumerate}
