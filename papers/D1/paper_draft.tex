...
$6.4\,T_{\rm eff}$ at the projected $^{39}$K parameters and
$10.6\,T_{\rm eff}$ at the $^{87}$Rb parameters, in both cases well below
...
% TODO: no source in hand derives the coefficient pi/6. Corley & Jacobson
% (PRD 54, 1568), read in full through Sec. 5.2 from the local corpus,
% report numerically fitted powers of T_H/k_0 and no analytic coefficient.
% Coutant-Parentani 2014 (PRD 89, 124004) is NOT cached; the cached
% Coutant file is Coutant, Parentani & Finazzi (arXiv:1108.1821), which
% supplies no such coefficient either. Either an additional source is
% obtained, or pi/6 remains a definition throughout, which is how it is
% presented here.
