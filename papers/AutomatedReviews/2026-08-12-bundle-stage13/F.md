...
- **Total findings (lifetime):** 460
- **Open findings (post-supersession):** 106
- **Blocker-class (critical + major):** 17
- **Severity mix:** 72 advisory, 2 critical, 15 major, 17 minor
- **Gate mix:** 8 AssumptionDisclosure, 11 CitationIntegrity, 9 ComputationCorrectness, 8 CountFreshness, 15 CrossPaperConsistency, 5 LeanProofSubstance, 5 NarrativeGrounding, 15 ParameterProvenance, 1 ProductionRunHealth, 29 unclassified
