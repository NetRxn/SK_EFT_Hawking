...
- **Open findings (post-supersession):** 112
- **Blocker-class (critical + major):** 23
- **Severity mix:** 72 advisory, 9 critical, 14 major, 17 minor
- **Gate mix:** 8 AssumptionDisclosure, 13 CitationIntegrity, 10 ComputationCorrectness, 9 CountFreshness, 15 CrossPaperConsistency, 6 LeanProofSubstance, 5 NarrativeGrounding, 15 ParameterProvenance, 1 ProductionRunHealth, 30 unclassified
