...
Restricted $\bar{u}_q$ & & RestrictedUq.lean (11 thms) \\
SU(2)$_k$ fusion ($k$=1,2,3) & & SU2kFusion.lean (29 thms) \\
S-matrix + Verlinde & & SU2kSMatrix.lean (16 thms) \\
Ribbon / MTC definitions & & RibbonCategory.lean (5 thms + 3 classes) \\
E$_8$ lattice & & E8Lattice.lean (19 thms) \\
Algebraic Rokhlin ($8 \mid \sigma$) & & AlgebraicRokhlin.lean (10 thms) \\
Spin bordism $\to$ Wang & & SpinBordism.lean (8 thms) \\
...
$\det(S) \neq 0$ (the \emph{modularity condition}) are stated as
theorems. The Verlinde formula $N_{ij}^m = \sum_l S_{il}S_{jl}S_{ml}/S_{0l}$
...
$U_q(\mathfrak{sl}_2)$ with \texttt{HopfAlgebra} instance ---
together with the first affine quantum group $U_q(\widehat{\mathfrak{sl}}_2)$,
the first SU(2)$_k$ fusion computation from a quantum group,
