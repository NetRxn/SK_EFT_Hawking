...
Ribbon / MTC definitions & & RibbonCategory.lean (4 thms + 3 classes, 0 sorry) \\
...
the first restricted quantum group $\bar{u}_q(\mathfrak{sl}_2)$,
...
the first ribbon/MTC definitions, and the first formal decomposition
of the algebraic/topological content of Rokhlin's theorem. All with
zero axioms.

The broader project comprises 1179~theorems across 79~Lean~4 modules,
