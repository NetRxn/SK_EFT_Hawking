...
$\totaltheorems{}$~theorems with $\axiomcount{}$~axiom
(\texttt{gapped\_interface\_axiom}) across $\leanmodules{}$~modules
...
($\axiomcount{}$~axiom: \texttt{gapped\_interface\_axiom})
...
(20~theorems + 1~axiom: SPT phase types, gapped interface conjecture,
...
Total: $\totaltheorems{}$~theorems, $\axiomcount{}$~axiom, $\leanmodules{}$~modules.}
...
($\axiomcount{}$~axiom: gapped interface) across $\leanmodules{}$~modules. The three-pillar
