...
machine-checked algebraic core (first Ext computation over any Steenrod
subalgebra in a proof assistant). Bridge theorems connect the Witten
...
lattice chirality problem in Lean~4, comprising $\totaltheorems{}$~theorems
