...
748~theorems and 3~axioms across 49~modules (zero \texttt{sorry}), of which
252~are proved by the Aristotle automated theorem prover. The work is
...
formalization totals 748~theorems and 3~axioms across 49~Lean modules
(zero \texttt{sorry}), of which 252 are proved by the Aristotle
...
Total: 748~theorems + 3~axioms, 49~modules, zero \texttt{sorry}.}
...
Anomaly framework (Pillar~3) & 103 & Proved + 1~axiom \\
Master synthesis (Bridges) & 17 & Proved \\
Prior infrastructure & 518 & Proved + 2~axioms \\
\midrule
\textbf{Total} & \textbf{748 + 3~ax} & \textbf{Zero sorry} \\
\bottomrule
\end{tabular}
\caption{Formalization summary. All theorems are machine-checked by
\texttt{lake build}. The three axioms are: $\Omega_4^{\mathrm{Pin}^+} \cong
\mathbb{Z}_{16}$ (cobordism), GS no-go theorem (unbounded spectral
theory), and gauge erasure universality.}
\label{tab:summary}
\end{table}

\noindent\textbf{What is proved:} All 748 theorems, including $[H,Q_A]=0$,
...
conditions, TPF evasion, and all bridge connections.

\noindent\textbf{What is axiomatized:} Pin$^+$ bordism (15--25
person-years of algebraic topology), spectral gap existence (Yang-Mills
mass gap difficulty), gauge erasure universality.
...
lattice chirality problem in Lean~4, comprising 748~theorems and
3~axioms across 49~modules with zero \texttt{sorry}. The three-pillar
