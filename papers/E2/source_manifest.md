...
| `paper16_graphene_sk_eft` | (see mapping) | Lift-companion | (see mapping) | 2026-05-12T12:42:35Z |
...
- Re-run `scripts/bundle_source_manifest.py --bundle E2` after any change to `docs/PAPER_DRAFT_MAPPING.md` affecting this bundle.
