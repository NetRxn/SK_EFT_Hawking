...
quantitative disfavour ledgers, of which three (Verlinde~2017,
Tsallis~HDE, Odintsov-D'Onofrio-Paul) reach Jeffreys-decisive at the
Bayes-factor level ($|\!\log\mathcal{B}| \geq 5$) and the fourth
...
the ``considerably less support'' regime). The two routes are
formalized in the Lean aggregators
\texttt{both\_decisive\_bayes\_bounds\_exceed\_jeffreys\_decisive}
(3 of 4) and \texttt{all\_quantitative\_bounds\_disfavoured} (4 of 4
under mixed thresholds); the
...
$|\!\log\mathcal{B}|$ bounds (each individually exceeding the
Jeffreys-decisive threshold $|\!\log\mathcal{B}| \geq 5$ and aggregated
in \texttt{all\_quantitative\_bounds\_exceed\_jeffreys\_decisive}: Verlinde~2017,
Tsallis~HDE, Barrow~HDE, Odintsov-D'Onofrio-Paul) and four structurally
...
\texttt{both\_decisive\_bayes\_bounds\_exceed\_jeffreys\_decisive}
(3 of 4 quantitative ledgers — Verlinde, Tsallis, Odintsov — at
Bayes-factor Jeffreys-decisive) and
\texttt{all\_quantitative\_bounds\_disfavoured} (all 4 at moderate-or-greater
disfavour, with Barrow at the AIC moderate level) close the mechanism
...
structural disfavour ledgers (three Bayes-factor decisive bounds + one
...
Bayes-factor / information-criteria methodology).
