...
The eight per-candidate theorems above each establish their NO-GO from
that candidate's own quantitative falsifier; that is where the proof load
sits. The aggregator \texttt{entropic\_gravity\_no\_go\_count\_eight}
