...
canonical Steinhauer-class $^{87}\text{Rb}$ parameters
\cite{FinazziLiberatiSindoni2012Proc} (Eq.~67/71); the FLS p.~16
domain-of-validity constraint $\rho_0 a^3 \ll 1$ enforces this
strict-inequality bound non-tunably. The $^3\!\text{He-A}$
