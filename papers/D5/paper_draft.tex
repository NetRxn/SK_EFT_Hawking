...
via two structurally distinct routes: four candidates (Verlinde~2017,
Tsallis~HDE, Barrow~HDE, Odintsov-D'Onofrio-Paul) yield quantitative
Bayesian bounds with $|\!\log\mathcal{B}| \geq 5$ (Jeffreys-decisive),
formalized in the Lean aggregator
\texttt{all\_quantitative\_bounds\_exceed\_jeffreys\_decisive}; the
