...
from the DESI~DR2 $w_0 w_a$CDM posteriors~\cite{DESI2025},
...
Van Waerbeke--Zhitnitsky topological-DE mechanism, a structural bridge
...
decidable predicates in Lean~4 (\texttt{EquivalencePrinciple.lean}),
...
\item \texttt{tsallis\_hde\_no\_go\_bayes\_factor\_tyagi\_haridasu\_basak}:
  Tyagi-Haridasu-Basak 2504.11308 reports $\Delta\!\log\mathcal{B}
