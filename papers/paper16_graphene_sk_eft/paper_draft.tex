...
as $\Gamma_0 = 4 c_R v/(c_R+v)^2 \approx 0.9994$ for the Dean nozzle
...
$\Gamma_0 \approx 0.9994$. The frequency dependence in the adiabatic
...
\texttt{QuasiOneDReduction} (theorems T1--T5). Numerical predictions
...
With the realistic $\Gamma(\omega) \approx \Gamma_0 \approx 0.9994$
...
nozzle (realistic greybody $\Gamma_0 \approx 0.9994$ per
Eq.~\eqref{eq:gamma0}).
...
(using $\Gamma_0 \approx 0.9994$) at low frequencies, independent of
...
\cdot \Delta f]$.
With the realistic $\Gamma_0 \approx 0.9994$
...
$\Gamma_0 \approx 0.9994$, quasi-1D correction
$\le 1.8\%$). The ratio is
