...
formally verified in Lean~4 (44~theorems, zero sorry) and derive from
a computation pipeline with 103~tests.
\end{abstract}
...
Computation pipeline formally verified with 44~new Lean~4 theorems
