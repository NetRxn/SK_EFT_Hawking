...
band, extractable from the thermal Johnson-Nyquist background via correlation
analysis in approximately 27~minutes of integration.
...
reaching unity in approximately \SI{27}{\minute} of integration
(Fig.~\ref{fig:snr}). This estimate assumes the radiometer equation
...
fluctuations near quantum criticality could increase the required integration
time. The 27-minute figure should be understood as a \emph{lower bound};
a $5\sigma$ discovery threshold would require ${\sim}25\times$ longer or
...
\item \textbf{Integration:} ${\sim}\SI{27}{\minute}$ for cumulative
SNR~$=1$ across the detection band.
...
signal is detectable in ${\sim}\SI{27}{\minute}$.
