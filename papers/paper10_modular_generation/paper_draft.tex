...
The formal verification comprises 968~theorems across 66~Lean~4
modules (zero axioms, zero \texttt{sorry} in main modules). The key modules are
...
and \texttt{RokhlinBridge.lean} (``16'' convergence, Rokhlin hypothesis,
