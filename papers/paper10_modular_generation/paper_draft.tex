...
comprises 936~theorems + 2~axioms across 63~Lean~4 modules with zero
\texttt{sorry}. This is the first formal derivation connecting
...
The formal verification records this as \texttt{wang\_sixteen\_convergence}
in \texttt{WangBridge.lean}: the SM Weyl count equals the $\mathbb{Z}_{16}$
modulus.
...
The formal verification comprises 936~theorems + 2~axioms across 63~Lean~4
modules. The key modules---all with zero \texttt{sorry}---are
...
Aristotle \texttt{a1dfcbde}), and
\texttt{ModularInvarianceConstraint.lean} (framing anomaly: $q$-parameter
shift proved, complex exponential identities pending Aristotle).
