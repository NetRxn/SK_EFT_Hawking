...
comprises 968~theorems across 66~Lean~4 modules (zero axioms, zero
...
The formal verification now comprises 1100+~theorems across 76~Lean~4
...
(E$_8$ is even unimodular with $\sigma = 8$, disproving the naive
