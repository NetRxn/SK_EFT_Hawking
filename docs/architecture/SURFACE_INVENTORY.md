...
> Generated by `scripts/architecture_inventory.py`. Every table below is read from the
> artifact that owns the population — the check registry, the gate roster, the plugin
> manifest, the AST of the graph builder. **Do not edit this file**: run
