...
| 1 | D11 | Topological & metamaterial band theory (Chern/bulk-boundary + phononic gaps + non-Herm/EP + Maxwell–Garnett + graphene band structure) | PRD/PRX-Q/PRB | ~40pp | (after phase exec) | Phases 6CA/6CB/6CD/6CE (+6CC→D2 or here); **authorized 2026-06-29**; +6ED (graphene/Haldane) **2026-07-27**; scaffolding at first-lift |
