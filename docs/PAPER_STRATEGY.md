...
### 2.2 Tier 1 — themed deep papers (11 papers, D1–D11)
...
Sources: Phases 6CA, 6CB, 6CD, 6CE (+ 6CC reframe → D2 or here). Authorized 2026-06-29; all Lean substrate, kernel-pure. **On-disk scaffolding executes at first content-lift** per `BUNDLE_LIFT_PROCEDURE`.
...
| 1 | D11 | Topological & metamaterial band theory (Chern/bulk-boundary + phononic gaps + non-Herm/EP + Maxwell–Garnett) | PRD/PRX-Q/PRB | ~40pp | (after phase exec) | Phases 6CA/6CB/6CD/6CE (+6CC→D2 or here); **authorized 2026-06-29**, scaffolding at first-lift |
