...
**Status:** 15 of 21 bundles declared (D1–D12, F, I1, L2).
6 undeclared: E1, E2, I2, I3, L1, L3. **Every "not decided" below is a
...
| D1, D2, D3, D5, D7, D8, D11, D12, I1, L2 | **No** | Each states its purpose on its own substrate. D11 is the strongest case: zero intersection with every other declared bundle. |
| E1, E2, I2, I3, L1, L3 | **not yet measurable** | undeclared |
