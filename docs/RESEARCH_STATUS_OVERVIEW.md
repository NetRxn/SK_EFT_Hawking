...
> **Note (2026-06-10):** Header counts are refreshed to the current `docs/counts.json` (regenerated 2026-06-10): **936 modules, 12,463 theorems, 0 axioms, 0 sorry**. The per-phase module list above is a curated representative map, not the full 936-module enumeration — `docs/counts.json` field `lean.module_names` is the canonical complete list, and `SK_EFT_Hawking_Inventory_Index.md` is the LLM-friendly module index.
