...
from module docstrings and regenerated by `sync`, so the way to change a module's description is
to change its docstring. The six-item *watch for* list this stage used to carry — new modules,
