...
**Goal:** the strengthening pass that runs at end-of-wave (`feedback_post_wave_strengthening_audit.md`) should produce **0 retroactive theorems**. If it produces 5+, the first pass missed structural opportunities — log them and tighten the next wave's discipline.
