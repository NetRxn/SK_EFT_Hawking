...
Dedicated Lean identification of the coherent constants remains pending; generic normalization/causality references alone do not establish those specific constants. The example distinguishes these chosen protocols, not every classical hidden-state or entanglement-breaking explanation. The reset-only contrast also has an incoherent-mixture realization. No experimental observation, quantum advantage or unusual-time claim follows.
