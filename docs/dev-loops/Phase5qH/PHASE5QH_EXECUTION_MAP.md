...
> **⚠ WORKTREE TRUTH UPDATE (lead, 2026-07-12):** wt1 has since accumulated **7 NEW unmerged commits** (2026-07-05, `a2abee8c`→`d7c5805a` — the integral relative-UCT / `sourceIso` discharge chain ending `EuclLocalCapIsoData.ofFundCycle`; targets atlas node `intLocalHomologyIso_datum`, gates 7). The 2026-07-04 "harvest = no-op" note below applies ONLY to the old tip `b3956505`. Harvest to main via a wt2 lean-worker dispatched 2026-07-12 (duplication check first — main also built local-iso work on 2026-07-05). wt2/wt3 verified clean (0 unmerged); wt2 reset to main @ `11c82f99` for the harvest.
