...
>
> ⚠ **One item unaccounted for:** the original banner numbered the minors `M1–M8`, but the wt1 remediation brief enumerated `M1–M7` plus the two 6EB minors. Everything enumerated in the brief is closed; if a distinct **M8** exists in the review record it is **still open** and needs its text restored here.
