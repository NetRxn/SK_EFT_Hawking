...
- **Wave 1b 🟡** — Stage 5 project-local Witt-class shipped through Stage 5.7 (AddCommGroup transport). **Stage 5.8+ Witt group of MTCs full structure** is the natural Wave 1b continuation: Drinfeld center construction (1-2 sessions; ref Müger 2003 arXiv:math/0111205) → Witt-equivalence-via-Drinfeld-center → Deligne tensor product as group operation (2-3 sessions; ref Davydov-Müger-Nikshych-Ostrik 2010 arXiv:1009.2117). Total ~5-7 sessions. Substrate ready: lean-tensor-categories at 114 thms (Phase 5o W5). Lagrangian algebra (within MTC framework) chains naturally off Stage 5.8+ as Stage 5.9 (~5-7 sessions).
...
**Highest-leverage Session 15+ priority order (Phase 6n continuation):**
1. **Wave 1b.5.8+ Drinfeld center construction** — single-session deliverable on lean-tensor-categories MTC substrate; opens 5-7 session continuation chain to full Witt-group structure.
2. **Wave 2c.5c+ abstract LDP rate function class** — single-session deliverable on Mathlib MeasureTheory substrate; opens 10-15 session continuation chain to full LDP framework.
3. **Wave 1a.3 Stage 4b** — pre-session prerequisite: fetch Shi-Griffin to cache via background Explore agent; few-session SymPy lift after fetch.

**Pre-Phase-7 bundle absorption gate:** Wave 1b.5.8+ + Wave 2c.5c+ + Wave 1a.3 Stage 4b form the Phase 6n true-closure prerequisite. Phase 6o opens after these close. After Phase 6n + 6o math both close, the unified bundle-absorption pass per Session-5 user direction runs — two D.3 user-auth gates (Wave 2a I1, Wave 2d D3+L3) trigger at that point.
