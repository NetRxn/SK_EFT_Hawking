...
- **Discharge path.** Requires a Newman-Penrose / 2-spinor formalism absent from Mathlib: spinor dyads, the Weyl spinor decomposition, principal null directions, and the Petrov classification theorem (CK-Duality DR §8.2 flags the same absence for spinor-helicity). A future Phase 6X wave or Mathlib spinor-geometry contribution; Phase 6o-prime Wave 1b-prime tracks it (docs/roadmaps/Phase6o_prime_Roadmap.md).
