...
differ by 21.5 points (52.7 % vs 31.2 % at `γ(2,4) = 0.47315`; 52.7 − 31.2; the rounded figures give 22), so the comparison needs one fixed. Read as a *maximum* the amplitude reading is
