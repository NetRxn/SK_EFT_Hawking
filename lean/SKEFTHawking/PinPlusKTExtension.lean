...
noncomputable def ktRP4Class (prov : CharPairWProviderPinned (𝓡 4) 0) :
...
noncomputable def ktKernelRep (prov : CharPairWProviderPinned (𝓡 4) 0) :
    T2DataBordismGrp (pinPlusCharPairData prov) :=
  (8 : ℕ) • ktRP4Class prov
...
def KTKernelOrderTwo (prov : CharPairWProviderPinned (𝓡 4) 0) : Prop :=
...
def KTKernelCard (prov : CharPairWProviderPinned (𝓡 4) 0) : Prop :=
...
def KTNonSplit (prov : CharPairWProviderPinned (𝓡 4) 0) : Prop :=
  ktKernelRep prov ≠ 0
...
def KTNonSplitKummerTarget (prov : CharPairWProviderPinned (𝓡 4) 0)
...
theorem KTNonSplit_of_KummerTarget (prov : CharPairWProviderPinned (𝓡 4) 0)
...
theorem charPairBrown_ktRP4Class (prov : CharPairWProviderPinned (𝓡 4) 0) :
...
theorem ktRP4Class_ne_zero (prov : CharPairWProviderPinned (𝓡 4) 0) : ktRP4Class prov ≠ 0 :=
...
theorem charPairBrown_ktKernelRep (prov : CharPairWProviderPinned (𝓡 4) 0) :
...
theorem charPairBrown_of_rank_zero (prov : CharPairWProviderPinned (𝓡 4) 0)
...
theorem kernel_card_two (prov : CharPairWProviderPinned (𝓡 4) 0)
...
theorem kt_card_eq_16 (prov : CharPairWProviderPinned (𝓡 4) 0)
    (hcard : KTKernelCard prov) (hns : KTNonSplit prov) :
...
theorem kt_rp4_addOrderOf (prov : CharPairWProviderPinned (𝓡 4) 0)
    (hcard : KTKernelCard prov) (hns : KTNonSplit prov) :
...
theorem kt_equiv_zmod16 (prov : CharPairWProviderPinned (𝓡 4) 0)
    (hcard : KTKernelCard prov) (hns : KTNonSplit prov) :
...
theorem kt_kernelOrderTwo_of_card (prov : CharPairWProviderPinned (𝓡 4) 0)
