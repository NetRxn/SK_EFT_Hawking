...
3. `gm-triple-level-layer-is-decided-by-sigma-alone` [structural_forcing]
...
4. `freeze-a-atoms-satisfiable-with-zero-geometry` [structural_forcing]
...
5. `hker-single-witness-extraction-is-equivalent-to-gluing` [structural_forcing]
...
6. `hcolD-same-carrier-collapse-refuted-on-wu-witness` [structural_forcing]
...
7. `capstone-binary-partition-detection-uninhabitable` [structural_forcing]
...
8. `collar-pair-hdetAB-one-sided-congruence-routes-dead` [structural_forcing]
...
9. `collar-pair-core-row-alone-is-vacuous-at-empty-seamcore` [vacuity]
...
10. `nonhausdorff-bordism-collapse` [refutation]
...
11. `comp-twist-doubling-incompatible` [structural_forcing]
...
12. `membrane-level-nonhausdorff-collapse` [refutation]
...
13. `free-membrane-kernel-kills-nonsplit` [refutation]
...
14. `tied-carrier-inhabitation-equiv-free` [structural_forcing]
...
15. `realization-seam-basis-gauge-launders-e8` [refutation]
...
16. `wadm-sqop-gauge-w2-filter-vacuous` [refutation]
...
17. `taylor-leg-end-convention-trap` [structural_forcing]
...
18. `untethered-membrane-factors-relation` [structural_forcing]
...
19. `nogo_lattice_arf_not_sigma8` [refutation]
...
20. `mfd-equals-H1-dead-end` [structural_forcing]
...
21. `synthetic-grade-ker-bot-nogo` [structural_forcing]
...
22. `synthetic-smith-map-to-tied-carrier` [structural_forcing]
...
23. `5qH-injectivity-routes-all-equal-one-completeness-prop` [structural_forcing]
...
24. `5qH-fg-ek-over-Z-blocked` [refutation]
...
25. `genuine-gm-carrier-eight-torsion` [refutation]
...
26. `enriques-datum-refuted-as-shaped` [structural_forcing]
...
27. `geometric-phi-does-not-close-hfwd-fakeability` [structural_forcing]
...
28. `dual-spin-opened-construction-conclusion-fakeable` [structural_forcing]
...
29. `hker-opener-supplyGeo-is-non-reducing` [structural_forcing]
...
30. `hker-ambient-pin-does-not-restore-geometry` [structural_forcing]
...
31. `novikov-substrate-synthetic-inhabitation` [structural_forcing]
...
32. `novikov-geometric-tower-carrier-conclusion-fakeable` [structural_forcing]
...
33. `seam-transfer-open-support-uninhabitable` [refutation]
...
34. `k0-to-k1-transport-refuted` [refutation]
...
35. `collar-pair-closed-seam-attached-collar-bridge-is-FALSE` [refutation]
...
36. `collar-pair-face-row-forces-seam-to-meet-boundary` [structural_forcing]
...
37. `collar-pair-open-complement-annulus-is-refuted-shape` [structural_forcing]
...
38. `collar-pair-maximal-core-reenters-refuted-support` [structural_forcing]
...
39. `k7-seam-cover-interior-fails` [refutation]
...
40. `gram-literal-equality-is-choice-dependent` [structural_forcing]
...
41. `kronecker-dual-is-not-the-h1-enhancement-transport` [refutation]
