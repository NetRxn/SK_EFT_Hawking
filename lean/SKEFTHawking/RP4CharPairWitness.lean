...
theorem charPairBrown_mk {E : Type*} [NormedAddCommGroup E] [NormedSpace ℝ E]
    ...
    (prov : CharPairWProvider I k) (p : StrMfd (pinPlusCharPairData prov).toTangentialData) :
...
theorem charPairBrown_rp4_eq_one (prov : CharPairWProvider (𝓡 4) 0) :
    charPairBrown prov
...
theorem charPairBrown_surjective (prov : CharPairWProvider (𝓡 4) 0) :
...
theorem charPairBrown_rp4_ne_zero (prov : CharPairWProvider (𝓡 4) 0) :
