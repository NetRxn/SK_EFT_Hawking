...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22634 |
| Lean theorems (total) | 13897 |
| Lean theorems (substantive) | 13871 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1056 |
| Lean definitions | 7764 |
| Lean structures | 309 |
| Lean instances | 567 |
| Lean inductives | 97 |
