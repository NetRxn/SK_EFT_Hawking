...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 32409 |
| Lean theorems (total) | 20315 |
| Lean theorems (substantive) | 20289 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1743 |
| Lean definitions | 10779 |
| Lean structures | 431 |
| Lean instances | 784 |
| Lean inductives | 100 |
