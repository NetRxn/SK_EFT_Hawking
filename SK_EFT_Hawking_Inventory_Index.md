...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 20875 |
| Lean theorems (total) | 12706 |
| Lean theorems (substantive) | 12680 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 959 |
| Lean definitions | 7251 |
| Lean structures | 298 |
| Lean instances | 523 |
| Lean inductives | 97 |
