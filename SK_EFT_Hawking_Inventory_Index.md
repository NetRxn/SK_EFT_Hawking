...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39928 |
| Lean theorems (total) | 25806 |
| Lean theorems (substantive) | 25780 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2004 |
| Lean definitions | 12621 |
| Lean structures | 472 |
| Lean instances | 928 |
| Lean inductives | 101 |
