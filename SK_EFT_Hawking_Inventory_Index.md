...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22591 |
| Lean theorems (total) | 13864 |
| Lean theorems (substantive) | 13838 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1048 |
| Lean definitions | 7754 |
| Lean structures | 309 |
| Lean instances | 567 |
| Lean inductives | 97 |
