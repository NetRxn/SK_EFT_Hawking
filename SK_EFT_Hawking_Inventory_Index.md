...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 30932 |
| Lean theorems (total) | 19425 |
| Lean theorems (substantive) | 19399 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1678 |
| Lean definitions | 10257 |
| Lean structures | 410 |
| Lean instances | 740 |
| Lean inductives | 100 |
