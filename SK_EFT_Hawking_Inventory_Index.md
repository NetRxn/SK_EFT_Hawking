...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23001 |
| Lean theorems (total) | 14164 |
| Lean theorems (substantive) | 14138 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1126 |
| Lean definitions | 7845 |
| Lean structures | 310 |
| Lean instances | 585 |
| Lean inductives | 97 |
