...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29679 |
| Lean theorems (total) | 18712 |
| Lean theorems (substantive) | 18686 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1594 |
| Lean definitions | 9759 |
| Lean structures | 378 |
| Lean instances | 730 |
| Lean inductives | 100 |
