...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 40678 |
| Lean theorems (total) | 26364 |
| Lean theorems (substantive) | 26338 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2037 |
| Lean definitions | 12794 |
| Lean structures | 479 |
| Lean instances | 939 |
| Lean inductives | 101 |
