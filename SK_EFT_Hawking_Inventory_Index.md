...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 20866 |
| Lean theorems (total) | 12699 |
| Lean theorems (substantive) | 12673 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 958 |
| Lean definitions | 7249 |
| Lean structures | 298 |
| Lean instances | 523 |
| Lean inductives | 97 |
