...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21309 |
| Lean theorems (total) | 12939 |
| Lean theorems (substantive) | 12913 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 981 |
| Lean definitions | 7417 |
| Lean structures | 305 |
| Lean instances | 551 |
| Lean inductives | 97 |
