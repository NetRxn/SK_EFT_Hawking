...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26421 |
| Lean theorems (total) | 16670 |
| Lean theorems (substantive) | 16644 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1426 |
| Lean definitions | 8673 |
| Lean structures | 337 |
| Lean instances | 641 |
| Lean inductives | 100 |
