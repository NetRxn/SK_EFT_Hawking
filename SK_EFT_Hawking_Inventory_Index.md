...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 31215 |
| Lean theorems (total) | 19554 |
| Lean theorems (substantive) | 19528 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1683 |
| Lean definitions | 10390 |
| Lean structures | 419 |
| Lean instances | 752 |
| Lean inductives | 100 |
