...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39639 |
| Lean theorems (total) | 25548 |
| Lean theorems (substantive) | 25522 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2003 |
| Lean definitions | 12592 |
| Lean structures | 470 |
| Lean instances | 928 |
| Lean inductives | 101 |
