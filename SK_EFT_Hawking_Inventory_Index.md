...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22718 |
| Lean theorems (total) | 13938 |
| Lean theorems (substantive) | 13912 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1077 |
| Lean definitions | 7789 |
| Lean structures | 309 |
| Lean instances | 585 |
| Lean inductives | 97 |
