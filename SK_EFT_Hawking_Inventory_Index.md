...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39170 |
| Lean theorems (total) | 25184 |
| Lean theorems (substantive) | 25158 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1983 |
| Lean definitions | 12491 |
| Lean structures | 467 |
| Lean instances | 927 |
| Lean inductives | 101 |
