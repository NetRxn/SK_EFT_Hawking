...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29767 |
| Lean theorems (total) | 18749 |
| Lean theorems (substantive) | 18723 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1598 |
| Lean definitions | 9808 |
| Lean structures | 380 |
| Lean instances | 730 |
| Lean inductives | 100 |
