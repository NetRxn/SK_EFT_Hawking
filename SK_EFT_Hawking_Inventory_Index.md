...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24311 |
| Lean theorems (total) | 15214 |
| Lean theorems (substantive) | 15188 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1231 |
| Lean definitions | 8078 |
| Lean structures | 318 |
| Lean instances | 604 |
| Lean inductives | 97 |
