...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 28412 |
| Lean theorems (total) | 17900 |
| Lean theorems (substantive) | 17874 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1518 |
| Lean definitions | 9345 |
| Lean structures | 357 |
| Lean instances | 710 |
| Lean inductives | 100 |
