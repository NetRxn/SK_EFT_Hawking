...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21579 |
| Lean theorems (total) | 13123 |
| Lean theorems (substantive) | 13097 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 986 |
| Lean definitions | 7496 |
| Lean structures | 307 |
| Lean instances | 556 |
| Lean inductives | 97 |
