...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21413 |
| Lean theorems (total) | 13013 |
| Lean theorems (substantive) | 12987 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 983 |
| Lean definitions | 7445 |
| Lean structures | 307 |
| Lean instances | 551 |
| Lean inductives | 97 |
