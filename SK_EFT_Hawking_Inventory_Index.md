...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37919 |
| Lean theorems (total) | 24224 |
| Lean theorems (substantive) | 24198 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1927 |
| Lean definitions | 12221 |
| Lean structures | 456 |
| Lean instances | 918 |
| Lean inductives | 100 |
