...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22298 |
| Lean theorems (total) | 13641 |
| Lean theorems (substantive) | 13615 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1018 |
| Lean definitions | 7686 |
| Lean structures | 309 |
| Lean instances | 565 |
| Lean inductives | 97 |
