...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29579 |
| Lean theorems (total) | 18644 |
| Lean theorems (substantive) | 18618 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1588 |
| Lean definitions | 9731 |
| Lean structures | 377 |
| Lean instances | 727 |
| Lean inductives | 100 |
