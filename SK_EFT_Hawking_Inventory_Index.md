...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 40173 |
| Lean theorems (total) | 26018 |
| Lean theorems (substantive) | 25992 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2012 |
| Lean definitions | 12653 |
| Lean structures | 472 |
| Lean instances | 929 |
| Lean inductives | 101 |
