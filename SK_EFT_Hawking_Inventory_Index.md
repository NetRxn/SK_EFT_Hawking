...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36390 |
| Lean theorems (total) | 23100 |
| Lean theorems (substantive) | 23074 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1866 |
| Lean definitions | 11840 |
| Lean structures | 447 |
| Lean instances | 903 |
| Lean inductives | 100 |
