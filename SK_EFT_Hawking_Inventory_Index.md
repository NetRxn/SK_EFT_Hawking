...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24032 |
| Lean theorems (total) | 15028 |
| Lean theorems (substantive) | 15002 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1213 |
| Lean definitions | 8004 |
| Lean structures | 316 |
| Lean instances | 587 |
| Lean inductives | 97 |
