...
|------|-------|-----------------|
| Lean theorems | **3958** (3847 substantive + 111 placeholder; +229 from Phase 5y closure on top of session 9's 3729 baseline — 8 new modules + 3 extensions) | counts.json 2026-04-23 — package-module-bound count |
...
| Lean modules | **166** (was 158; +8 Phase 5y new: GibbsDuhemTheorem, QTheoryNoGoTheorem, DarkEnergyObstructionPrinciple, DESIComparison, CondensedMatterAnalog, VestigialMapping, VestigialEOS, ClassificationTableDark) | counts.json 2026-04-23 |
| Lean definitions | **3260** (was 2939; +321 from Phase 5y structures + enums + `noncomputable defs`) | counts.json 2026-04-23 |
