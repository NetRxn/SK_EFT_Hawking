...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26769 |
| Lean theorems (total) | 16867 |
| Lean theorems (substantive) | 16841 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1443 |
| Lean definitions | 8797 |
| Lean structures | 343 |
| Lean instances | 662 |
| Lean inductives | 100 |
