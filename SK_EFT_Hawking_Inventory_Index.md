...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24457 |
| Lean theorems (total) | 15308 |
| Lean theorems (substantive) | 15282 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1238 |
| Lean definitions | 8128 |
| Lean structures | 320 |
| Lean instances | 604 |
| Lean inductives | 97 |
