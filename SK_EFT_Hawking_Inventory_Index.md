...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26669 |
| Lean theorems (total) | 16801 |
| Lean theorems (substantive) | 16775 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1437 |
| Lean definitions | 8768 |
| Lean structures | 343 |
| Lean instances | 657 |
| Lean inductives | 100 |
