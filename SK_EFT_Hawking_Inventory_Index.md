...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 31628 |
| Lean theorems (total) | 19825 |
| Lean theorems (substantive) | 19799 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1713 |
| Lean definitions | 10522 |
| Lean structures | 425 |
| Lean instances | 756 |
| Lean inductives | 100 |
