...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39231 |
| Lean theorems (total) | 25237 |
| Lean theorems (substantive) | 25211 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1989 |
| Lean definitions | 12499 |
| Lean structures | 467 |
| Lean instances | 927 |
| Lean inductives | 101 |
