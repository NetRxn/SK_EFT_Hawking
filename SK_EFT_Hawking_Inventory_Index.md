...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39104 |
| Lean theorems (total) | 25133 |
| Lean theorems (substantive) | 25107 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1981 |
| Lean definitions | 12477 |
| Lean structures | 466 |
| Lean instances | 927 |
| Lean inductives | 101 |
