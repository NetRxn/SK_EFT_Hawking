...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 40138 |
| Lean theorems (total) | 25989 |
| Lean theorems (substantive) | 25963 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2012 |
| Lean definitions | 12648 |
| Lean structures | 472 |
| Lean instances | 928 |
| Lean inductives | 101 |
