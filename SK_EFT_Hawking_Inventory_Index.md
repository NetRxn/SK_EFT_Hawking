...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37356 |
| Lean theorems (total) | 23815 |
| Lean theorems (substantive) | 23789 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1900 |
| Lean definitions | 12073 |
| Lean structures | 450 |
| Lean instances | 918 |
| Lean inductives | 100 |
