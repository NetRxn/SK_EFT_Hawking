...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22196 |
| Lean theorems (total) | 13570 |
| Lean theorems (substantive) | 13544 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1017 |
| Lean definitions | 7657 |
| Lean structures | 309 |
| Lean instances | 563 |
| Lean inductives | 97 |
