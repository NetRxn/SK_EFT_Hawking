...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24359 |
| Lean theorems (total) | 15239 |
| Lean theorems (substantive) | 15213 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1233 |
| Lean definitions | 8100 |
| Lean structures | 319 |
| Lean instances | 604 |
| Lean inductives | 97 |
