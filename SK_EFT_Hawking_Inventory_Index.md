...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 27121 |
| Lean theorems (total) | 17086 |
| Lean theorems (substantive) | 17060 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1457 |
| Lean definitions | 8906 |
| Lean structures | 346 |
| Lean instances | 683 |
| Lean inductives | 100 |
