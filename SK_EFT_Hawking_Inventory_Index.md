...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22696 |
| Lean theorems (total) | 13930 |
| Lean theorems (substantive) | 13904 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1071 |
| Lean definitions | 7783 |
| Lean structures | 309 |
| Lean instances | 577 |
| Lean inductives | 97 |
