...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37817 |
| Lean theorems (total) | 24148 |
| Lean theorems (substantive) | 24122 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1919 |
| Lean definitions | 12195 |
| Lean structures | 456 |
| Lean instances | 918 |
| Lean inductives | 100 |
