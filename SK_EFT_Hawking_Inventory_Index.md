...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26484 |
| Lean theorems (total) | 16713 |
| Lean theorems (substantive) | 16687 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1432 |
| Lean definitions | 8692 |
| Lean structures | 338 |
| Lean instances | 641 |
| Lean inductives | 100 |
