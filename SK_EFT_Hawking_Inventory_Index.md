...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26935 |
| Lean theorems (total) | 16976 |
| Lean theorems (substantive) | 16950 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1449 |
| Lean definitions | 8848 |
| Lean structures | 343 |
| Lean instances | 668 |
| Lean inductives | 100 |
