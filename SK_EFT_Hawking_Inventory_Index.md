...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21360 |
| Lean theorems (total) | 12981 |
| Lean theorems (substantive) | 12955 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 982 |
| Lean definitions | 7426 |
| Lean structures | 305 |
| Lean instances | 551 |
| Lean inductives | 97 |
