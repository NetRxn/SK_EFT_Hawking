...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 38232 |
| Lean theorems (total) | 24461 |
| Lean theorems (substantive) | 24435 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1943 |
| Lean definitions | 12291 |
| Lean structures | 458 |
| Lean instances | 922 |
| Lean inductives | 100 |
