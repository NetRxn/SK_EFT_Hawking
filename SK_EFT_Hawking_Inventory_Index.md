...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26257 |
| Lean theorems (total) | 16586 |
| Lean theorems (substantive) | 16560 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1417 |
| Lean definitions | 8604 |
| Lean structures | 332 |
| Lean instances | 635 |
| Lean inductives | 100 |
