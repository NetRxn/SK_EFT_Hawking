...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39985 |
| Lean theorems (total) | 25855 |
| Lean theorems (substantive) | 25829 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2007 |
| Lean definitions | 12629 |
| Lean structures | 472 |
| Lean instances | 928 |
| Lean inductives | 101 |
