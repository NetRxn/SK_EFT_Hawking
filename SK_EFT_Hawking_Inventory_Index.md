...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24420 |
| Lean theorems (total) | 15278 |
| Lean theorems (substantive) | 15252 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1235 |
| Lean definitions | 8121 |
| Lean structures | 320 |
| Lean instances | 604 |
| Lean inductives | 97 |
