...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24543 |
| Lean theorems (total) | 15357 |
| Lean theorems (substantive) | 15331 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1240 |
| Lean definitions | 8163 |
| Lean structures | 320 |
| Lean instances | 606 |
| Lean inductives | 97 |
