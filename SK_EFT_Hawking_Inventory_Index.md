...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37577 |
| Lean theorems (total) | 23962 |
| Lean theorems (substantive) | 23936 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1912 |
| Lean definitions | 12143 |
| Lean structures | 454 |
| Lean instances | 918 |
| Lean inductives | 100 |
