...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21635 |
| Lean theorems (total) | 13151 |
| Lean theorems (substantive) | 13125 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 989 |
| Lean definitions | 7521 |
| Lean structures | 309 |
| Lean instances | 557 |
| Lean inductives | 97 |
