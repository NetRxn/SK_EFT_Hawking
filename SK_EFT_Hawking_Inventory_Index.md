...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29949 |
| Lean theorems (total) | 18847 |
| Lean theorems (substantive) | 18821 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1614 |
| Lean definitions | 9885 |
| Lean structures | 384 |
| Lean instances | 733 |
| Lean inductives | 100 |
