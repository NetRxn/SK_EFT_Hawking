...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 38702 |
| Lean theorems (total) | 24841 |
| Lean theorems (substantive) | 24815 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1964 |
| Lean definitions | 12377 |
| Lean structures | 461 |
| Lean instances | 923 |
| Lean inductives | 100 |
