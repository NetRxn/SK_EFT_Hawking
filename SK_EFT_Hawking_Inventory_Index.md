...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29037 |
| Lean theorems (total) | 18307 |
| Lean theorems (substantive) | 18281 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1560 |
| Lean definitions | 9537 |
| Lean structures | 366 |
| Lean instances | 727 |
| Lean inductives | 100 |
