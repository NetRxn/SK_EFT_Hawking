...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37198 |
| Lean theorems (total) | 23705 |
| Lean theorems (substantive) | 23679 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1895 |
| Lean definitions | 12037 |
| Lean structures | 450 |
| Lean instances | 906 |
| Lean inductives | 100 |
