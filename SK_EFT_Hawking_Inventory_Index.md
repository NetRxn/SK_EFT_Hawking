...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23485 |
| Lean theorems (total) | 14540 |
| Lean theorems (substantive) | 14514 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1154 |
| Lean definitions | 7947 |
| Lean structures | 315 |
| Lean instances | 586 |
| Lean inductives | 97 |
