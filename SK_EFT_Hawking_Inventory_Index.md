...
**Counts (from `docs/counts.json` regenerated 2026-06-10 PM, post external-review remediation sweep):**

| Metric | Value |
|---|---:|
| Lean theorems (total) | 12429 |
| Lean theorems (substantive) | 12403 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 934 |
| Lean definitions | 7133 |
