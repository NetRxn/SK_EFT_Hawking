...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23303 |
| Lean theorems (total) | 14373 |
| Lean theorems (substantive) | 14347 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1152 |
| Lean definitions | 7933 |
| Lean structures | 315 |
| Lean instances | 585 |
| Lean inductives | 97 |
