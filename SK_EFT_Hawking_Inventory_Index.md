...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 38145 |
| Lean theorems (total) | 24399 |
| Lean theorems (substantive) | 24373 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1937 |
| Lean definitions | 12271 |
| Lean structures | 457 |
| Lean instances | 918 |
| Lean inductives | 100 |
