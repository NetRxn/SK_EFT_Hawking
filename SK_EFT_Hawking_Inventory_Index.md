...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 38077 |
| Lean theorems (total) | 24339 |
| Lean theorems (substantive) | 24313 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1934 |
| Lean definitions | 12263 |
| Lean structures | 457 |
| Lean instances | 918 |
| Lean inductives | 100 |
