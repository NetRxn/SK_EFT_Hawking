...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37188 |
| Lean theorems (total) | 23696 |
| Lean theorems (substantive) | 23670 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1894 |
| Lean definitions | 12036 |
| Lean structures | 450 |
| Lean instances | 906 |
| Lean inductives | 100 |
