...
**Last synced:** 2026-05-26 PM (Phase 6w Wave 6w.1 KZM-Unruh bridge foundation shipped; `lean/SKEFTHawking/KibbleZurekUnruh.lean` new). **Sync source:** `docs/counts.json` regen pending (in flight; will tick module count 445 → 446, theorem count 7713 → 7720, build jobs 8693 → 8707).
