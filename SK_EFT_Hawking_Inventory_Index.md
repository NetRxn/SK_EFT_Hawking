...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29175 |
| Lean theorems (total) | 18372 |
| Lean theorems (substantive) | 18346 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1566 |
| Lean definitions | 9607 |
| Lean structures | 369 |
| Lean instances | 727 |
| Lean inductives | 100 |
