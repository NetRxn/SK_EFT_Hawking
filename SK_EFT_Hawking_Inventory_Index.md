...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 28265 |
| Lean theorems (total) | 17807 |
| Lean theorems (substantive) | 17781 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1512 |
| Lean definitions | 9292 |
| Lean structures | 356 |
| Lean instances | 710 |
| Lean inductives | 100 |
