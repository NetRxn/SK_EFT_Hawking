...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36291 |
| Lean theorems (total) | 23037 |
| Lean theorems (substantive) | 23011 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1862 |
| Lean definitions | 11806 |
| Lean structures | 446 |
| Lean instances | 902 |
| Lean inductives | 100 |
