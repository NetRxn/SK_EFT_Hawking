...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 34262 |
| Lean theorems (total) | 21592 |
| Lean theorems (substantive) | 21566 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1799 |
| Lean definitions | 11277 |
| Lean structures | 440 |
| Lean instances | 853 |
| Lean inductives | 100 |
