...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29401 |
| Lean theorems (total) | 18527 |
| Lean theorems (substantive) | 18501 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1581 |
| Lean definitions | 9675 |
| Lean structures | 372 |
| Lean instances | 727 |
| Lean inductives | 100 |
