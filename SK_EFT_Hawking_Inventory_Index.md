...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21520 |
| Lean theorems (total) | 13075 |
| Lean theorems (substantive) | 13049 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 985 |
| Lean definitions | 7486 |
| Lean structures | 307 |
| Lean instances | 555 |
| Lean inductives | 97 |
