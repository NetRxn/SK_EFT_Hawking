...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22386 |
| Lean theorems (total) | 13710 |
| Lean theorems (substantive) | 13684 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1027 |
| Lean definitions | 7705 |
| Lean structures | 309 |
| Lean instances | 565 |
| Lean inductives | 97 |
