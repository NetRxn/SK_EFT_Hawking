...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36538 |
| Lean theorems (total) | 23212 |
| Lean theorems (substantive) | 23186 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1872 |
| Lean definitions | 11872 |
| Lean structures | 448 |
| Lean instances | 906 |
| Lean inductives | 100 |
