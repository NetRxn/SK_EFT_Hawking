...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37101 |
| Lean theorems (total) | 23634 |
| Lean theorems (substantive) | 23608 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1891 |
| Lean definitions | 12012 |
| Lean structures | 449 |
| Lean instances | 906 |
| Lean inductives | 100 |
