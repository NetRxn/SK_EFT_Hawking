...
|------|-------|-----------------|
| Lean theorems | **4025** (3912 substantive + 113 placeholder; +32 from Phase 5z Wave 2 MajoranaRung + NeutrinoMixing on top of W1's 20) | counts.json 2026-04-26 — package-module-bound count |
...
| Lean modules | **169** (was 167; +2 Phase 5z Wave 2: `MajoranaRung`, `NeutrinoMixing`) | counts.json 2026-04-26 |
...
| Test files | **60** | +1 Phase 5z W2 (`tests/test_majorana_rung.py`, 32 tests / 6 classes) |
