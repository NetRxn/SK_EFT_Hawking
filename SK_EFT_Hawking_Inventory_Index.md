...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36452 |
| Lean theorems (total) | 23155 |
| Lean theorems (substantive) | 23129 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1869 |
| Lean definitions | 11845 |
| Lean structures | 447 |
| Lean instances | 905 |
| Lean inductives | 100 |
