...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23513 |
| Lean theorems (total) | 14566 |
| Lean theorems (substantive) | 14540 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1155 |
| Lean definitions | 7949 |
| Lean structures | 315 |
| Lean instances | 586 |
| Lean inductives | 97 |
