...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36344 |
| Lean theorems (total) | 23067 |
| Lean theorems (substantive) | 23041 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1863 |
| Lean definitions | 11828 |
| Lean structures | 447 |
| Lean instances | 902 |
| Lean inductives | 100 |
