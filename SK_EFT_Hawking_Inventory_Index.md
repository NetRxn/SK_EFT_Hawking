...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23284 |
| Lean theorems (total) | 14357 |
| Lean theorems (substantive) | 14331 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1149 |
| Lean definitions | 7930 |
| Lean structures | 315 |
| Lean instances | 585 |
| Lean inductives | 97 |
