...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26305 |
| Lean theorems (total) | 16602 |
| Lean theorems (substantive) | 16576 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1418 |
| Lean definitions | 8629 |
| Lean structures | 334 |
| Lean instances | 640 |
| Lean inductives | 100 |
