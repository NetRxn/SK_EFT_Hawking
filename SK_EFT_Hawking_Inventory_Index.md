...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 31343 |
| Lean theorems (total) | 19648 |
| Lean theorems (substantive) | 19622 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1695 |
| Lean definitions | 10424 |
| Lean structures | 419 |
| Lean instances | 752 |
| Lean inductives | 100 |
