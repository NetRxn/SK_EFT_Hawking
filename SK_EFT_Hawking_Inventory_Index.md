...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22438 |
| Lean theorems (total) | 13752 |
| Lean theorems (substantive) | 13726 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1035 |
| Lean definitions | 7715 |
| Lean structures | 309 |
| Lean instances | 565 |
| Lean inductives | 97 |
