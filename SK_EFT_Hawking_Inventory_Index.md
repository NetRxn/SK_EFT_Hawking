...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 20511 |
| Lean theorems (total) | 12471 |
| Lean theorems (substantive) | 12445 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 937 |
| Lean definitions | 7137 |
| Lean structures | 294 |
| Lean instances | 513 |
| Lean inductives | 96 |
