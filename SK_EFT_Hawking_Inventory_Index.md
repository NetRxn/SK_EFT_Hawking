...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37243 |
| Lean theorems (total) | 23744 |
| Lean theorems (substantive) | 23718 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1896 |
| Lean definitions | 12043 |
| Lean structures | 450 |
| Lean instances | 906 |
| Lean inductives | 100 |
