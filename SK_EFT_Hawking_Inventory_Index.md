...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 31468 |
| Lean theorems (total) | 19728 |
| Lean theorems (substantive) | 19702 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1704 |
| Lean definitions | 10462 |
| Lean structures | 422 |
| Lean instances | 756 |
| Lean inductives | 100 |
