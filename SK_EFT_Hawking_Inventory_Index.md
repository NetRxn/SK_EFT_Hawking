...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23079 |
| Lean theorems (total) | 14224 |
| Lean theorems (substantive) | 14198 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1134 |
| Lean definitions | 7863 |
| Lean structures | 310 |
| Lean instances | 585 |
| Lean inductives | 97 |
