...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 30712 |
| Lean theorems (total) | 19304 |
| Lean theorems (substantive) | 19278 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1665 |
| Lean definitions | 10169 |
| Lean structures | 405 |
| Lean instances | 734 |
| Lean inductives | 100 |
