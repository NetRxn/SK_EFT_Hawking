...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 31818 |
| Lean theorems (total) | 19946 |
| Lean theorems (substantive) | 19920 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1721 |
| Lean definitions | 10589 |
| Lean structures | 425 |
| Lean instances | 758 |
| Lean inductives | 100 |
