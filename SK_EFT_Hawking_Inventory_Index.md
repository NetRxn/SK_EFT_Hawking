...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36060 |
| Lean theorems (total) | 22871 |
| Lean theorems (substantive) | 22845 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1852 |
| Lean definitions | 11745 |
| Lean structures | 446 |
| Lean instances | 898 |
| Lean inductives | 100 |
