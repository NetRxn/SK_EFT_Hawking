...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 31560 |
| Lean theorems (total) | 19783 |
| Lean theorems (substantive) | 19757 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1709 |
| Lean definitions | 10498 |
| Lean structures | 423 |
| Lean instances | 756 |
| Lean inductives | 100 |
