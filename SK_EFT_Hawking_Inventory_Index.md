...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23020 |
| Lean theorems (total) | 14178 |
| Lean theorems (substantive) | 14152 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1131 |
| Lean definitions | 7850 |
| Lean structures | 310 |
| Lean instances | 585 |
| Lean inductives | 97 |
