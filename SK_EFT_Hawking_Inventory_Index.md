...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22665 |
| Lean theorems (total) | 13922 |
| Lean theorems (substantive) | 13896 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1063 |
| Lean definitions | 7770 |
| Lean structures | 309 |
| Lean instances | 567 |
| Lean inductives | 97 |
