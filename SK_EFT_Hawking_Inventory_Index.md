...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39575 |
| Lean theorems (total) | 25505 |
| Lean theorems (substantive) | 25479 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2000 |
| Lean definitions | 12571 |
| Lean structures | 470 |
| Lean instances | 928 |
| Lean inductives | 101 |
