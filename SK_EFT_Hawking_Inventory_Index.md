...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21149 |
| Lean theorems (total) | 12833 |
| Lean theorems (substantive) | 12807 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 972 |
| Lean definitions | 7366 |
| Lean structures | 304 |
| Lean instances | 549 |
| Lean inductives | 97 |
