...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24367 |
| Lean theorems (total) | 15246 |
| Lean theorems (substantive) | 15220 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1234 |
| Lean definitions | 8101 |
| Lean structures | 319 |
| Lean instances | 604 |
| Lean inductives | 97 |
