...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39515 |
| Lean theorems (total) | 25459 |
| Lean theorems (substantive) | 25433 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1998 |
| Lean definitions | 12559 |
| Lean structures | 469 |
| Lean instances | 927 |
| Lean inductives | 101 |
