...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24273 |
| Lean theorems (total) | 15193 |
| Lean theorems (substantive) | 15167 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1229 |
| Lean definitions | 8062 |
| Lean structures | 317 |
| Lean instances | 604 |
| Lean inductives | 97 |
