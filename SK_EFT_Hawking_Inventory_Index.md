...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39260 |
| Lean theorems (total) | 25256 |
| Lean theorems (substantive) | 25230 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1990 |
| Lean definitions | 12508 |
| Lean structures | 468 |
| Lean instances | 927 |
| Lean inductives | 101 |
