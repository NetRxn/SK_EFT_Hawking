...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 30072 |
| Lean theorems (total) | 18919 |
| Lean theorems (substantive) | 18893 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1621 |
| Lean definitions | 9932 |
| Lean structures | 388 |
| Lean instances | 733 |
| Lean inductives | 100 |
