...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36686 |
| Lean theorems (total) | 23332 |
| Lean theorems (substantive) | 23306 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1881 |
| Lean definitions | 11900 |
| Lean structures | 448 |
| Lean instances | 906 |
| Lean inductives | 100 |
