...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36990 |
| Lean theorems (total) | 23556 |
| Lean theorems (substantive) | 23530 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1890 |
| Lean definitions | 11979 |
| Lean structures | 449 |
| Lean instances | 906 |
| Lean inductives | 100 |
