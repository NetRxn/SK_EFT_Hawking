...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 28309 |
| Lean theorems (total) | 17822 |
| Lean theorems (substantive) | 17796 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1514 |
| Lean definitions | 9320 |
| Lean structures | 357 |
| Lean instances | 710 |
| Lean inductives | 100 |
