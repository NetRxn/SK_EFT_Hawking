...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21261 |
| Lean theorems (total) | 12904 |
| Lean theorems (substantive) | 12878 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 977 |
| Lean definitions | 7404 |
| Lean structures | 305 |
| Lean instances | 551 |
| Lean inductives | 97 |
