...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 38853 |
| Lean theorems (total) | 24967 |
| Lean theorems (substantive) | 24941 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1976 |
| Lean definitions | 12402 |
| Lean structures | 461 |
| Lean instances | 923 |
| Lean inductives | 100 |
