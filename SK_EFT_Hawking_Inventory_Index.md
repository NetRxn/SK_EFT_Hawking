...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29322 |
| Lean theorems (total) | 18466 |
| Lean theorems (substantive) | 18440 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1576 |
| Lean definitions | 9657 |
| Lean structures | 372 |
| Lean instances | 727 |
| Lean inductives | 100 |
