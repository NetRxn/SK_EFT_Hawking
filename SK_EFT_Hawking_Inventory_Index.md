...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 20561 |
| Lean theorems (total) | 12499 |
| Lean theorems (substantive) | 12473 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 940 |
| Lean definitions | 7156 |
| Lean structures | 294 |
| Lean instances | 515 |
| Lean inductives | 97 |
