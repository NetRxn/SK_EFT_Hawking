...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21616 |
| Lean theorems (total) | 13144 |
| Lean theorems (substantive) | 13118 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 988 |
| Lean definitions | 7510 |
| Lean structures | 308 |
| Lean instances | 557 |
| Lean inductives | 97 |
