...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36637 |
| Lean theorems (total) | 23294 |
| Lean theorems (substantive) | 23268 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1877 |
| Lean definitions | 11889 |
| Lean structures | 448 |
| Lean instances | 906 |
| Lean inductives | 100 |
