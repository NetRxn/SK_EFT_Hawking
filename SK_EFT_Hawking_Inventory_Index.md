...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29462 |
| Lean theorems (total) | 18574 |
| Lean theorems (substantive) | 18548 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1584 |
| Lean definitions | 9688 |
| Lean structures | 373 |
| Lean instances | 727 |
| Lean inductives | 100 |
