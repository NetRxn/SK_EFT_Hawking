...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 24124 |
| Lean theorems (total) | 15069 |
| Lean theorems (substantive) | 15043 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1220 |
| Lean definitions | 8039 |
| Lean structures | 317 |
| Lean instances | 602 |
| Lean inductives | 97 |
