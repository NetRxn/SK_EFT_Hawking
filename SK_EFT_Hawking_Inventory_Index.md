...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 38288 |
| Lean theorems (total) | 24508 |
| Lean theorems (substantive) | 24482 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1945 |
| Lean definitions | 12299 |
| Lean structures | 459 |
| Lean instances | 922 |
| Lean inductives | 100 |
