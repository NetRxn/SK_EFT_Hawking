...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36192 |
| Lean theorems (total) | 22964 |
| Lean theorems (substantive) | 22938 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1856 |
| Lean definitions | 11784 |
| Lean structures | 446 |
| Lean instances | 898 |
| Lean inductives | 100 |
