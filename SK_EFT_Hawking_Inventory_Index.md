...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 40668 |
| Lean theorems (total) | 26355 |
| Lean theorems (substantive) | 26329 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2036 |
| Lean definitions | 12793 |
| Lean structures | 479 |
| Lean instances | 939 |
| Lean inductives | 101 |
