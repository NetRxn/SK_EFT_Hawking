...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29847 |
| Lean theorems (total) | 18792 |
| Lean theorems (substantive) | 18766 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1603 |
| Lean definitions | 9842 |
| Lean structures | 383 |
| Lean instances | 730 |
| Lean inductives | 100 |
