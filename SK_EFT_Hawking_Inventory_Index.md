...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26247 |
| Lean theorems (total) | 16578 |
| Lean theorems (substantive) | 16552 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1415 |
| Lean definitions | 8602 |
| Lean structures | 332 |
| Lean instances | 635 |
| Lean inductives | 100 |
