...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21273 |
| Lean theorems (total) | 12914 |
| Lean theorems (substantive) | 12888 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 979 |
| Lean definitions | 7406 |
| Lean structures | 305 |
| Lean instances | 551 |
| Lean inductives | 97 |
