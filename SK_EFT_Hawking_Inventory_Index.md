...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22537 |
| Lean theorems (total) | 13825 |
| Lean theorems (substantive) | 13799 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1041 |
| Lean definitions | 7739 |
| Lean structures | 309 |
| Lean instances | 567 |
| Lean inductives | 97 |
