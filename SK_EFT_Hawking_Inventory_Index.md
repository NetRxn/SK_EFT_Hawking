...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39378 |
| Lean theorems (total) | 25358 |
| Lean theorems (substantive) | 25332 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1995 |
| Lean definitions | 12524 |
| Lean structures | 468 |
| Lean instances | 927 |
| Lean inductives | 101 |
