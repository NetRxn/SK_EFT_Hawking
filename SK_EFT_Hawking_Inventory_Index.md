...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 31858 |
| Lean theorems (total) | 19981 |
| Lean theorems (substantive) | 19955 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1725 |
| Lean definitions | 10593 |
| Lean structures | 425 |
| Lean instances | 759 |
| Lean inductives | 100 |
