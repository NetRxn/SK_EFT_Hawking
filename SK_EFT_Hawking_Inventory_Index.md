...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22685 |
| Lean theorems (total) | 13928 |
| Lean theorems (substantive) | 13902 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1067 |
| Lean definitions | 7778 |
| Lean structures | 309 |
| Lean instances | 573 |
| Lean inductives | 97 |
