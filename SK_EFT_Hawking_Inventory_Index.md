...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 22704 |
| Lean theorems (total) | 13937 |
| Lean theorems (substantive) | 13911 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1075 |
| Lean definitions | 7784 |
| Lean structures | 309 |
| Lean instances | 577 |
| Lean inductives | 97 |
