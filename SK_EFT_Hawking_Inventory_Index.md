...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37282 |
| Lean theorems (total) | 23772 |
| Lean theorems (substantive) | 23746 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1898 |
| Lean definitions | 12054 |
| Lean structures | 450 |
| Lean instances | 906 |
| Lean inductives | 100 |
