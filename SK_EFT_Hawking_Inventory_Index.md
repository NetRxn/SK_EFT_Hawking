...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 20567 |
| Lean theorems (total) | 12504 |
| Lean theorems (substantive) | 12478 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 941 |
| Lean definitions | 7157 |
| Lean structures | 294 |
| Lean instances | 515 |
| Lean inductives | 97 |
