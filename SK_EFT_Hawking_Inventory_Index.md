...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 28893 |
| Lean theorems (total) | 18208 |
| Lean theorems (substantive) | 18182 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1545 |
| Lean definitions | 9500 |
| Lean structures | 366 |
| Lean instances | 719 |
| Lean inductives | 100 |
