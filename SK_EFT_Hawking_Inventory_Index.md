...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 30406 |
| Lean theorems (total) | 19121 |
| Lean theorems (substantive) | 19095 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1645 |
| Lean definitions | 10055 |
| Lean structures | 397 |
| Lean instances | 733 |
| Lean inductives | 100 |
