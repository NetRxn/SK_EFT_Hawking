...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 39537 |
| Lean theorems (total) | 25474 |
| Lean theorems (substantive) | 25448 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1999 |
| Lean definitions | 12564 |
| Lean structures | 470 |
| Lean instances | 928 |
| Lean inductives | 101 |
