...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 37138 |
| Lean theorems (total) | 23656 |
| Lean theorems (substantive) | 23630 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1892 |
| Lean definitions | 12026 |
| Lean structures | 450 |
| Lean instances | 906 |
| Lean inductives | 100 |
