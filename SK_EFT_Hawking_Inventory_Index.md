...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 36941 |
| Lean theorems (total) | 23512 |
| Lean theorems (substantive) | 23486 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1888 |
| Lean definitions | 11974 |
| Lean structures | 449 |
| Lean instances | 906 |
| Lean inductives | 100 |
