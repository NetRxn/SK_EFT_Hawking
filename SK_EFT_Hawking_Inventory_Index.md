...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23160 |
| Lean theorems (total) | 14267 |
| Lean theorems (substantive) | 14241 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1138 |
| Lean definitions | 7897 |
| Lean structures | 314 |
| Lean instances | 585 |
| Lean inductives | 97 |
