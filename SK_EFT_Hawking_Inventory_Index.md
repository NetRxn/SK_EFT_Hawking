...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23192 |
| Lean theorems (total) | 14290 |
| Lean theorems (substantive) | 14264 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1142 |
| Lean definitions | 7906 |
| Lean structures | 314 |
| Lean instances | 585 |
| Lean inductives | 97 |
