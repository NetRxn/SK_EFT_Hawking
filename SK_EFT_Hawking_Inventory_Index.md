...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26098 |
| Lean theorems (total) | 16448 |
| Lean theorems (substantive) | 16422 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1369 |
| Lean definitions | 8585 |
| Lean structures | 332 |
| Lean instances | 635 |
| Lean inductives | 98 |
