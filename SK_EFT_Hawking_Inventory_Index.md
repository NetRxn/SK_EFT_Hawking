...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21209 |
| Lean theorems (total) | 12869 |
| Lean theorems (substantive) | 12843 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 974 |
| Lean definitions | 7388 |
| Lean structures | 304 |
| Lean instances | 551 |
| Lean inductives | 97 |
