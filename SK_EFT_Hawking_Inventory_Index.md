...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 40202 |
| Lean theorems (total) | 26046 |
| Lean theorems (substantive) | 26020 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 2012 |
| Lean definitions | 12654 |
| Lean structures | 472 |
| Lean instances | 929 |
| Lean inductives | 101 |
