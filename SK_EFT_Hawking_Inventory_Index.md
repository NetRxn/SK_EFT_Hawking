...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 21094 |
| Lean theorems (total) | 12800 |
| Lean theorems (substantive) | 12774 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 970 |
| Lean definitions | 7347 |
| Lean structures | 302 |
| Lean instances | 548 |
| Lean inductives | 97 |
