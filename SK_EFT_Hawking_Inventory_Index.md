...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 28588 |
| Lean theorems (total) | 18015 |
| Lean theorems (substantive) | 17989 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1525 |
| Lean definitions | 9400 |
| Lean structures | 363 |
| Lean instances | 710 |
| Lean inductives | 100 |
