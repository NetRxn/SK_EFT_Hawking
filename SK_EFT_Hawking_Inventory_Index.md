...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 29077 |
| Lean theorems (total) | 18329 |
| Lean theorems (substantive) | 18303 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1562 |
| Lean definitions | 9554 |
| Lean structures | 367 |
| Lean instances | 727 |
| Lean inductives | 100 |
