...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 26557 |
| Lean theorems (total) | 16752 |
| Lean theorems (substantive) | 16726 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1435 |
| Lean definitions | 8724 |
| Lean structures | 340 |
| Lean instances | 641 |
| Lean inductives | 100 |
