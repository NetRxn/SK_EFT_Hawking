...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 23314 |
| Lean theorems (total) | 14382 |
| Lean theorems (substantive) | 14356 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1153 |
| Lean definitions | 7935 |
| Lean structures | 315 |
| Lean instances | 585 |
| Lean inductives | 97 |
