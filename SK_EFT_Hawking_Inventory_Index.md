...
| Metric | Value |
|---|---:|
| Lean declarations (total) | 28217 |
| Lean theorems (total) | 17786 |
| Lean theorems (substantive) | 17760 |
| Lean theorems (placeholder `True := trivial`) | 26 |
| Lean modules | 1511 |
| Lean definitions | 9267 |
| Lean structures | 354 |
| Lean instances | 710 |
| Lean inductives | 100 |
