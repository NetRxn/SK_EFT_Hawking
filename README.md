...
**Lean 4 formalization:** **3004 theorems** (2926 substantive + 78 placeholder) across **132 modules**. 1 axiom (gapped_interface_axiom), **0 sorry project-wide**.
...
```
SK_EFT_Hawking/
├── lean/                              # Lean 4 formalization (3004 theorems, 1 axiom, 132 modules, 0 sorry)
...
## Theorem Inventory (3004 theorems — 1 axiom, **0 sorry**)
