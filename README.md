...
| `analog_hawking_tree_simulable_demarcation + surface_gravity_bounds_kzm_exponent` | `AnalogHawkingDemarcation.lean`, `KibbleZurekUnruh.lean` | Classical-simulability ↔ quantum-advantage demarcation (tree-factor-graph belief-propagation + categorical-Chern bridge); KZM–Unruh bridge to a D-Wave-measurable exponent. |
