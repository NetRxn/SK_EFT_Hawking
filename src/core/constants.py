...
#   - 322 tracked in ARISTOTLE_THEOREMS registry (316 machine + 6 manual, listed below with run IDs)
...
ARISTOTLE_THEOREMS = {
    ...
    #    statements. RESOLVED 2026-08-13 (operator): both moved to 'manual'. A run id that
    #    certifies a DIFFERENT statement is a false provenance claim, which is the defect
    #    class this review exists to remove — re-submitting the new statements to Aristotle
    #    later restores machine provenance honestly. `c1_implies_i2` is unchanged.
    'tpf_violates_C2': 'manual',
    'tpf_outside_gs_scope': 'manual',
...
EXISTENTIAL_ESCAPE_CEILING: int = 0
