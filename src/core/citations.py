...
CITATION_REGISTRY = {
    ...
    'mathlib4_2020': {
        ...
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/mathlib4_2020.pdf',
    ...
    'IrwinHilton2005': {
        ...
        'notes': 'Source of the loop-gain convention L = P_J*alpha/(G*T) that 6EC proves equivalent to its own definition (loopGain_eq_irwinHilton).',
    },
    'BlochSiegert1940': {
