...
PAPER_TO_PHASE: dict[str, str] = {
    # Publication bundles whose citations are bundle-only (first-lift 2026-07-30).
    # Without these, bibkey_phase() falls through to Phase-1-and-Background and
    # the 6C*/6E* primary-source caches would be filed under an unrelated phase.
    'D11':                                   'Phase-6c',
    'D12':                                   'Phase-6e',
...
CITATION_REGISTRY = {
    ...
    # NJL gap equation — cited for what the literature does NOT impose (I1 §4)
    'Buballa2005': {
        'authors': 'Buballa, M.',
        ...
        'provides': [],
        'notes': ('Cited in I1 for a NEGATIVE result verified against the source: sec. 2.2.2 / '
                  'Fig. 2.6 computes a high-mass branch where the dynamical mass is comparable '
                  'to or exceeds the cutoff, and selects against it using phenomenological '
                  'bounds on the quark condensate rather than any mass-below-cutoff criterion. '
                  'No reviewed source imposes gap < cutoff as a validity condition.'),
    },
    ...
    'Falque2025': {
        ...
        'used_in': ['src/core/constants.py', 'papers/paper12_polariton', 'papers/D1/paper_draft.tex'],
        'provides': [
            'POLARITON_MASS',
    ...
    'Giacobino2025': {
        ...
        'used_in': ['papers/paper12_polariton', 'papers/D1/paper_draft.tex'],
        'provides': [],
    ...
    'Grisins2016': {
        ...
        'used_in': ['src/core/constants.py', 'papers/D1/paper_draft.tex'],
        'provides': [],
        'notes': 'Theoretical study of stimulated/spontaneous Hawking effects from acoustic black hole in polariton fluid. Five-author paper (Grisins, Nguyen, Bloch, Amo, Carusotto); registry already had correct title. D1 used_in added 2026-05-11 (Stage-13 fix-pass: prior D1 bibitem had paraphrased title `Theoretical proposal for the experimental realization of a monochromatic Hawking emission in a quasi-1D BEC` which did not match the published PRB title).',
    },
    'Jacquet2022': {
    ...
    'Jacquet2023QNM': {
        'authors': 'Jacquet, M. J., Giacomelli, L., Valnais, Q., Joly, M., Claude, F., Giacobino, E., Glorieux, Q., Carusotto, I., Bramati, A.',
        'title': 'Quantum Vacuum Excitation of a Quasinormal Mode in an Analog Model of Black Hole Spacetime',
        'journal': 'PRL',
        'volume': 130,
        'page': '111501',
        'year': 2023,
        ...
        'provides': [],
        'notes': 'Quasinormal-mode observation in polariton analog (driven-dissipative). Crossref-verified 2026-05-11 (D1 Stage-13 fix-pass): actual title is `Quantum Vacuum Excitation of a Quasinormal Mode in an Analog Model of Black Hole Spacetime`; prior registry title `Analogue quantum simulation of the quasi-normal modes of a Kerr black hole` was misattributed (the polariton platform is NOT a Kerr analog).',
    },
    'Nelsen2013': {
    ...
    'Volovik2024': {
        ...
        'provides': [],
        'notes': 'Vestigial metric phase concept. NOTE: same paper as '
                 '`Volovik2024Vestigial` (arXiv:2312.09435 → JETP Letters 119:330, '
                 '2024); the two keys exist for historical reasons in different '
                 'paper drafts. Consolidate in a future pass.',
    },
    ...
    'Crossley2017': {
        ...
        'provides': [],
        'notes': 'SK-EFT framework (paper I), dynamical KMS transformation. Paper II of the CGL series is registered separately as Crossley2017II.',
    },
    'Crossley2017II': {
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Crossley2017II.pdf',
        'used_in': ['papers/D1/paper_draft.tex'],
        'provides': [],
        'notes': 'CGL paper II: classical limit, dynamical KMS symmetry and entropy current. Glorioso lead author. JHEP 09, 096 (2017), DOI 10.1007/JHEP09(2017)096. Registry entry added 2026-05-11 (D1 Stage-13 fix-pass: D1 paper had previously used `Crossley2017` bibkey collision with registry paper-I entry; bibkey renamed to `Crossley2017II` to disambiguate).',
    },
    'GloriosoLiu2018': {
        ...
        'notes': 'SK-EFT second law without NEC. arXiv:1612.07705 verified 2026-04-26; year/journal corrected 2026-05-11 (Bundle I1 Stage-13 fix-pass) — WebFetch on arxiv.org/abs/1612.07705 confirms first-submitted Dec 2016, no JHEP publication info on arXiv metadata (registry key retained as GloriosoLiu2018 for backwards-compat with downstream cites; bibitem cites (2016) correctly).',
    },
    'Jana2020': {
        'authors': 'Jana, C., Loganayagam, R., Rangamani, M.',
        ...
        'used_in': ['papers/paper1_first_order/paper_draft.tex',
                    ...
                    'papers/D1/paper_draft.tex'],
        'provides': [],
        'notes': 'SK influence functional / open-quantum-systems holographic dual. First author initial C (Chandan Jana). JHEP 07, 242 (2020), DOI 10.1007/JHEP07(2020)242, arXiv:2004.02888. Registry corrected 2026-05-11 (D1 Stage-13 fix-pass: registry previously carried wrong first-author initial K, wrong volume/page 2005/064, wrong arXiv 2003.03088 which is a superconductor paper).',
    },
    ...
    'GoltermanShamir2026': {
        ...
        'title': 'Symmetric mass generation and the Nielsen-Ninomiya theorem',
        'journal': 'arXiv preprint (contribution to Lattice 2025 proceedings)',
        'volume': None,
        'page': None,
        'year': 2026,
        'doi': None,
        ...
        'provides': [],
        'notes': 'GS no-go theorem: 9 conditions. Basis for Paper 7. Verified 2026-05-11 via WebFetch arXiv:2603.15985 (D2 Stage-13 fix-pass): actual title is "Symmetric mass generation and the Nielsen-Ninomiya theorem"; comment field "8 pages, 1 figure, contribution to the proceedings of Lattice 2025"; journal-ref empty (preprint only, intended for PoS Lattice 2025 proceedings). Prior cached title "Generalized no-go theorem for chiral fermions on a lattice" + venue "Phys. Rev. D 113, 014503 (2026)" were both fabricated.',
    },
    ...
    'CGL2017b': {
        ...
        'provides': [],
        'notes': 'CGL paper II (JHEP 09, 096 (2017)). Glorioso lead author. arXiv 1701.07817. Registry corrected 2026-05-11 (D1 Stage-13 fix-pass): canonical cross-bundle convention is CGL2017b = paper II (matches E2, L3, I1, paper17, paper16). D1 had a bibkey collision where its CGL2017b bibitem cited the Glorioso-Liu second-law paper (GloriosoLiu2018 / arXiv:1612.07705); D1 was renamed to use GloriosoLiu2018 directly.',
    },
    'Volovik2006': {
        'authors': 'Volovik, G. E.',
    ...
    'Kitaev2009': {
        ...
        'notes': 'Tenfold-way periodic table of topological phases (Kitaev 2009). '
                 'BDI class reference for Paper 18 W5 symmetry layer. used_in '
                 'completed 2026-05-31 to all four actual consumers (D2, L2, '
                 'paper10, paper18) per Stage-13 finding L2:1.3.',
    },
    'AltlandZirnbauer': {
    ...
    'KLRS1996': {
        ...
        'used_in': ['papers/paper22_ew_phase_transition/paper_draft.tex',
                    'papers/I1/paper_draft.tex'],
        'provides': [],
        # ⚠️ NOTE REWRITTEN TO THE SOURCE 2026-08-14 (I1 Stage-13 finding 1.3). The
        # previous note read "crossover for m_H >~ 72 GeV … canonical crossover
        # threshold m_H_crit = 72 ± 2 GeV" and attributed that number to THIS paper.
        # KLRS96 contains no "72": the string is CFH99's, and the two notes in this
        # registry contradicted each other on the point.
        'notes': 'KLRS 1996 3D-effective-theory + lattice Monte Carlo study of the hot electroweak transition. '
                 'Abstract verbatim (arxiv.org/abs/hep-ph/9605288, re-fetched 2026-08-14): '
                 '"In the minimal standard electroweak theory 70 GeV < m_{H,c} < 95 GeV and most likely m_{H,c} ~ 80 GeV." '
                 'This paper therefore sets a RANGE (70-95 GeV, most likely ~80 GeV) for the critical endpoint, '
                 'NOT the 72.4 ± 1.7 GeV figure — that value is CsikorFodorHeitger1999 '
                 '(arxiv.org/abs/hep-ph/9809291: "the Higgs-boson endpoint mass in the Standard Model is 72.4 ± 1.7 GeV"). '
                 'Phase 5z Wave 3 cite for the SM-as-crossover verdict; cited by I1 §5 for the range, which I1 states correctly. '
                 'doi_verified: arXiv journal-ref confirms Phys. Rev. Lett. 77, 2887-2890 (1996).',
    },
    ...
    'Sakharov1968': {
        ...
        'provides': ['Sakharov induced-gravity foundation (vacuum fluctuations in curved space generate the Einstein-Hilbert effective action via heat-kernel a_2 coefficient); foundational anchor for D3 §1, §21 emergent-gravity derivation.'],
        'notes': 'Pre-DOI (1968 Sov. Phys. Dokl. 12, 1040 — translated from Dokl. Akad. Nauk SSSR 177, 70); canonical-reference textbook exemption per Pipeline Invariant #11 (no DOI/arXiv/primary-source cache required for pre-DOI Soviet publications). Verified via secondary academic citations across the induced-gravity literature. Same exemption pattern as Trautman1973. Original induced-gravity reference: G_N from vacuum fluctuations, G_N⁻¹ ∝ Λ². Foundational anchor for the SK-EFT Hawking program.',
    },
    'Adler1982': {
        'authors': 'Adler, S. L.',
    ...
    'Akama1978': {
        ...
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-5d/primary-sources/Akama1978.json',
        'used_in': ['papers/paper5_adw_gap/paper_draft.tex',
                    'papers/paper23_linearized_efe/paper_draft.tex'],
        'provides': [],
        'notes': 'Original ADW reference: composite metric from fermion bilinear. '
                 'The "A" in ADW (Akama-Diakonov-Wetterich). Original tetrad '
                 'condensation idea.',
    },
    ...
    'Wetterich2022': {
        ...
        'used_in': ['papers/paper23_linearized_efe/paper_draft.tex'],
        'provides': [],
        'notes': 'Pregeometry / spontaneous time-space asymmetry formulation; '
                 'framework setup but no closed-form α_ADW.',
    },
    'Volovik2022Counting': {
        'authors': 'Volovik, G. E.',
    ...
    # Note: WalkerWang2012 duplicate-key removed 2026-05-11 (D3 Stage-13 fix-pass).
    # The canonical entry is the verified-and-cached form below at line ~4599
    # which has the WebFetch-verified DOI + primary-source PDF cache. This
    # earlier block was silently shadowed by Python last-write-wins; metadata
    # consolidated into the surviving entry.
    ...
    'GloriosoLiu2018TASI': {
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/GloriosoLiu2018TASI.pdf',
        'used_in': ['papers/I1/paper_draft.tex'],
    ...
    'Schellekens1993': {
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Schellekens1993.pdf',
        'used_in': ['papers/D2/paper_draft.tex',
                    'papers/L2/paper_draft.tex'],
    ...
    'MollerScheithauer2024': {
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/MollerScheithauer2024.pdf',
        'used_in': ['papers/D2/paper_draft.tex',
                    'papers/L2/paper_draft.tex'],
    ...
    'Crooks1999': {
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Crooks1999.pdf',
        'used_in': ['papers/D3/paper_draft.tex',
                    'papers/L3/paper_draft.tex'],
    ...
    'JainKovtun2024': {
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/JainKovtun2024.pdf',
        'used_in': ['papers/I1/paper_draft.tex'],
    ...
    'HeinzSnellings2013': {
        'authors': 'Heinz, U. and Snellings, R.',
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/HeinzSnellings2013.abstract.txt',
        'used_in': ['notebooks/Phase6d1_CenterSymmetry_Stakeholder.ipynb'],
        'provides': [],
        'notes': 'Primary-source backing for the QGP shear-viscosity-to-entropy ratio eta/s ~ 0.10-0.20 (1-2.5x KSS bound) quoted in the Phase 6d1 CenterSymmetry stakeholder notebook. Added 2026-05-31 to ground Stage-13 finding paper36:4.1; DOI Crossref-verified 2026-05-31.',
    },
    ...
    'WalkerWang2012': {
        ...
        'provides': [
            'Walker-Wang TQFTs hosting (3+1)-D anyon-line excitations',
            'Walker-Wang 4D TQFT bulk ↔ 3D anomalous SET boundary mapping',
            'Anomaly-inflow framework for the Z₂-time-reversal-symmetric bulk ↔ chiral c_- boundary mod 8',
        ],
        'notes': 'Walker-Wang (3+1)-dimensional TQFT framework. Source of the Z₂-time-reversal anomaly-match conjecture for the ADW bulk ↔ horizon MTC inflow (novelty-flagged in Wave 3 paper26). Also provides the topological-phase context paper36 invokes for the Walker-Wang anyon-mediated transport modelling assumption (no transport prediction is derived from this reference). Consolidated 2026-05-11 (D3 Stage-13 fix-pass) from duplicate-key shadowing.',
    },
    ...
    'Adams1974': {
        ...
        'journal': 'University of Chicago Press (Chicago Lectures in Mathematics)',
        'volume': None,
        'page': None,
        'year': 1974,
        'doi': None,
        ...
        'used_in': ['papers/paper10_modular_generation/paper_draft.tex',
                    ...
                    'papers/D2/paper_draft.tex'],
        'provides': [],
        'notes': 'Adams 1974 Chicago Lectures volume "Stable Homotopy and Generalised Homology". Used in D2/L2 for the ko-cohomology tracked hypothesis H1 and for general Adams spectral sequence context. Note: the D2 bibitem string previously read "Generalised Cohomology" (one-letter typo); corrected in 2026-05-11 Stage-13 fix-pass to match this canonical registry title.',
    },
    ...
    'AlvarezGaumeWitten1984': {
        'authors': "Alvarez-Gaumé, L. and Witten, E.",
    ...
    'DolanGrady1982': {
        ...
        'used_in': ['papers/paper8_chirality_master/paper_draft.tex',
                    'papers/D2/paper_draft.tex'],
        'provides': [],
        'notes': 'Dolan-Grady relations underlying the Onsager algebra. Registry corrected 2026-05-11 (D2 Stage-13 fix-pass): venue is Phys. Rev. D 25, 1587 (1982), not Phys. Rev. Lett. 49 as the auto-stub recorded; D2 bibitem already had the correct PRD coordinates.',
    },
    ...
    'FidkowskiKitaev2010': {
        'authors': 'Fidkowski, L. and Kitaev, A.',
        'title': 'The effects of interactions on the topological classification of free fermion systems',
    ...
    'GarciaEtxebarria2019': {
        'authors': "García-Etxebarria, I. and Montero, M.",
        'title': 'Dai-Freed anomalies in particle physics',
    ...
    'Geurs2025': {
        ...
        'used_in': ['papers/paper16_graphene_sk_eft/paper_draft.tex',
                    ...
                    'papers/E2/paper_draft.tex'],
        'provides': [],
        'notes': 'Originally an auto-generated stub from the \\bibitem block in '
                 '`papers/paper16_graphene_sk_eft/paper_draft.tex`, whose parser wrote '
                 "title='et~al.' — the same artifact round-1 BLOCKER 1.4 flagged on "
                 'Majumdar2025. Repaired to the verbatim title and the full author list; '
                 'E2 used_in added 2026-05-11, D1 used_in added 2026-08-14 (D1 cites this '
                 'key at §1 and had been omitted, the last open half of Stage-13 finding '
                 '2026-05-06-bundle-stage13:D1-r2:1.3). doi_verified stays False because '
                 'the work carries NO DOI: it is an arXiv preprint (2509.16321) with no '
                 'journal version, so True would assert a verification of a nonexistent '
                 'identifier. Title/authors are verified against the cached primary source '
                 'by validate.py --check bibitem_title_primary_source.',
    },

    # DEPRECATED ALIAS — `GioiaTh2026` historically used by paper7 + paper8 with
    # wrong first-author initial ('D.~Gioia'); content-equivalent to
    # `GioiaThorngrenPRL2026` (the canonical bibkey after Phase 7 Session 6
    # consolidation, 2026-05-11). The entry is retained as a duplicate-content
    # alias so existing `\cite{GioiaTh2026}` in paper7/paper8 still resolve;
    # downstream papers should use `GioiaThorngrenPRL2026`.
    'GioiaTh2026': {
        'authors': 'Gioia, L. and Thorngren, R.',
        ...
        'used_in': ['papers/paper7_chirality_formal/paper_draft.tex',
                    'papers/paper8_chirality_master/paper_draft.tex'],
        'provides': [],
        'notes': 'DEPRECATED ALIAS for GioiaThorngrenPRL2026 (same arxiv 2503.07708; same PRL coordinates). Verified 2026-05-11 via WebFetch arXiv:2503.07708 (D2 Stage-13 fix-pass): first-author initial is L (Lei), not D as previously recorded; actual title "Exact Chiral Symmetries of 3+1D Hamiltonian Lattice Fermions"; journal-ref Phys. Rev. Lett. 136, 061601 (2026). Original auto-stub note: "Title not present in source bibitem."',
    },
    ...
    'GioiaThorngrenPRL2026': {
        ...
        'used_in': ['papers/paper9_sm_anomaly_drinfeld/paper_draft.tex',
                    'papers/D2/paper_draft.tex'],
        'provides': [],
        'notes': 'Canonical bibkey for Gioia-Thorngren arxiv 2503.07708 / PRL 136, 061601 (2026). Verified 2026-05-11 via WebFetch arXiv:2503.07708 (D2 Stage-13 fix-pass): first-author initial is L (Lei), title "Exact Chiral Symmetries of 3+1D Hamiltonian Lattice Fermions". Prior stub had wrong initial M, empty title, no arxiv. Cross-bundle: `GioiaTh2026` retained as deprecated alias for paper7/paper8.',
    },

    'GrossJackiw1972': {
        'authors': 'Gross, D. J. and Jackiw, R.',
    ...
    'KSS2005': {
        ...
        'inprep': False,
        'primary_source_path': None,
        'used_in': ['papers/paper16_graphene_sk_eft/paper_draft.tex', 'papers/D3/paper_draft.tex'],
        'provides': ['Holographic shear viscosity bound η/s ≥ ℏ/(4π k_B); load-bearing for D3 §14 transport regime classification.'],
        'notes': 'Verified 2026-05-11 via WebFetch arXiv:hep-th/0405231 (D3 Stage-13 fix-pass). Title corrected from stub-empty to canonical published form; metadata restored from auto-generated stub.',
    },
    ...
    'Kitaev2003': {
        ...
        'doi_verified': '2026-05-11',
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-5b/primary-sources/Kitaev2003.pdf',
        'used_in': [
            'papers/paper9_sm_anomaly_drinfeld/paper_draft.tex',
            'papers/D4/paper_draft.tex',
        ],
        'provides': ['Foundational topological-quantum-computation reference; anyonic braiding for fault tolerance.'],
    ...
    # ════════════════════════════════════════════════════════════════
    # D8 — Kernel-Verified Universal Quantum Gate Compilation
    # (Phase 6p/6t/6u/6x/6x'/6y/6z verified-compilation corpus).
    # arXiv IDs web-verified 2026-05-31; abstracts cached under
    # Lit-Search/Phase-1-and-Background/primary-sources/.
    # ════════════════════════════════════════════════════════════════

    'BMPRV1999': {
        'authors': 'Boykin, P. O. and Mor, T. and Pulver, M. and Roychowdhury, V. and Vatan, F.',
        'title': 'On universal and fault-tolerant quantum computing',
        'journal': 'Proc. 40th Annual Symposium on Foundations of Computer Science (FOCS)',
        'volume': None,
        'page': '486-494',
        'year': 1999,
        'doi': None,
        ...
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/BMPRV1999.abstract.txt',
        'used_in': ['papers/D8/paper_draft.tex'],
        'provides': [],
        'notes': 'Universality of {H, T, CNOT} (Clifford+T). Source of the algebraic-integer (Niven-style) density argument for <H,T> dense in SU(2). arXiv ID verified 2026-05-31.',
    },

    'ReadRezayi1999': {
        'authors': 'Read, N. and Rezayi, E.',
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/ReadRezayi1999.abstract.txt',
        'used_in': ['papers/D8/paper_draft.tex'],
        'provides': [],
        'notes': 'Read-Rezayi SU(2)_k parafermion series; the universal-anyon family beyond Fibonacci (k=3). Levels k=5, k=7 instantiated as D8 compilation alphabets. arXiv ID verified 2026-05-31.',
    },

    'Brylinski2002': {
        'authors': 'Brylinski, J.-L. and Brylinski, R.',
        ...
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Brylinski2002.abstract.txt',
        'used_in': ['papers/D8/paper_draft.tex'],
        'provides': [],
        'notes': 'Entangling-gate universality criterion; the SU(4) density witness for the trapped-ion Molmer-Sorensen alphabet. arXiv ID verified 2026-05-31.',
    },

    'AaronsonGottesman2004': {
        'authors': 'Aaronson, S. and Gottesman, D.',
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/AaronsonGottesman2004.abstract.txt',
        'used_in': ['papers/D8/paper_draft.tex'],
        'provides': [],
        'notes': 'Clifford-group structure; SU(8) Clifford+T density route (Route A). arXiv ID is quant-ph/0406196 (NOT 0403025, which is Bravyi-Kitaev). Verified 2026-05-31.',
    },
    ...
    'Mukhopadhyay2024': {
        ...
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Mukhopadhyay2024.abstract.txt',
        'used_in': ['papers/D8/paper_draft.tex'],
        'provides': [],
        'notes': 'Channel-representation resource theory for Clifford+Toffoli (=Clifford+CCZ); Lemma 3.10 dyadic entries + Toffoli-cost lower bound T^of >= sde_2. Title + sole author verified 2026-05-31.',
    },
    ...
    'KMM2013': {
        ...
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/KMM2013.abstract.txt',
        'used_in': ['papers/D8/paper_draft.tex'],
        'provides': [],
        'notes': 'Exact synthesis of single-qubit Clifford+T unitaries over Z[1/sqrt2, i]; algorithmic-synthesis route (future work, out of D8 verified-existence scope). arXiv ID verified 2026-05-31.',
    },

    'Hietala2020VOQC': {
        'authors': 'Hietala, K. and Rand, R. and Hung, S.-H. and Wu, X. and Hicks, M.',
    ...
    'RossSelinger2016': {
        'authors': 'Ross, N. J. and Selinger, P.',
        ...
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/RossSelinger2016.abstract.txt',
        'used_in': ['papers/D8/paper_draft.tex'],
        'provides': [],
        'notes': 'Optimal ancilla-free Clifford+T z-rotation synthesis over Z[omega][1/sqrt2]; length-optimal route (future work, out of D8 verified-existence scope). arXiv ID verified 2026-05-31.',
    },
    ...
    'Nielsen1981a': {
        'authors': 'Nielsen, H. B. and Ninomiya, M.',
        ...
        'used_in': ['papers/paper7_chirality_formal/paper_draft.tex',
                    ...
                    'papers/D2/paper_draft.tex'],
        'provides': [],
        'notes': 'Nielsen-Ninomiya theorem paper I (NPB 185:20, 1981). Registry aligned 2026-05-11 to D2 bundle bibitem mapping (Stage-13 fix-pass): Nielsen1981a → NPB I, Nielsen1981b → NPB II. Prior registry recorded PLB 105:219 (1981) — a different Nielsen-Ninomiya paper ("No-go theorem for regularizing chiral fermions"). The PLB paper is no longer registered; if a paper needs that reference it should use a new bibkey (e.g. NielsenNinomiya1981PLB).',
    },
    ...
    'Nielsen1981b': {
        ...
        'used_in': ['papers/paper7_chirality_formal/paper_draft.tex',
                    ...
                    'papers/D2/paper_draft.tex'],
        'provides': [],
        'notes': 'Nielsen-Ninomiya theorem paper II (NPB 193:173, 1981). Registry aligned 2026-05-11 to D2 bundle bibitem mapping (Stage-13 fix-pass). Prior registry recorded NPB 185:20 (which is the paper-I content) under this bibkey.',
    },
    ...
    'Son2002': {
        ...
        'used_in': ['papers/paper1_first_order/paper_draft.tex',
                    'papers/D1/paper_draft.tex'],
        'provides': [],
        'notes': "Son's superfluid effective-action preprint (4 pages, INT-PUB 02-35). No traditional journal publication; lives as arXiv hep-ph/0204199 only. Registry entry repaired 2026-05-11 (D1 Stage-13 fix-pass: prior auto-stub had title='Phys.\\ Rev.\\ D', year=2013, no arXiv/DOI — completely wrong).",
    },
    ...
    'TPF2026': {
        'authors': 'Thorngren, R. and Preskill, J. and Fidkowski, L.',
        ...
        'used_in': ['papers/paper7_chirality_formal/paper_draft.tex',
                    ...
                    'papers/D2/paper_draft.tex'],
        'provides': [],
        'notes': 'Verified 2026-05-11 via WebFetch arXiv:2601.04304 (D2 Stage-13 fix-pass): actual title "Chiral Lattice Gauge Theories from Symmetry Disentanglers" (not "Two-Particle Family construction for chiral fermions" as previously recorded); preprint submitted January 7, 2026, no formal publication venue. "TPF" remains project shorthand for the Two-Particle-Family construction discussed in the paper.',
    },
    ...
    'Wang2024': {
        'authors': 'Wang, J.',
        'title': 'Family Puzzle, Framing Topology, $c_- = 24$ and $3(E_8)_1$ Conformal Field Theories: $48/16 = 45/15 = 24/8 = 3$',
        'journal': None,
        'volume': None,
        'page': None,
        'year': 2023,
        ...
        'used_in': ['papers/paper10_modular_generation/paper_draft.tex',
                    ...
                    'papers/L2/paper_draft.tex',
                    'papers/D2/paper_draft.tex'],
        'provides': ['Modular constraint 24 | c_- on chiral central charge of partition function under T-transformation tau -> tau+1; with SM c_- = 8 N_f, forces N_f in (48/16 = 24/8 = 3) Z.'],
        'notes': 'arXiv-only; NO journal reference. ⚠️ 2026-08-12 WRONG-TARGET CORRECTION: this entry previously carried journal Physical Review D 110, 125028 (2024) and doi 10.1103/PhysRevD.110.125028 with doi_verified=True. That DOI resolves — but to a DIFFERENT paper: arXiv:2302.14862, Putrov and Wang, "Categorical Symmetry of the Standard Model from Gravitational Anomaly", whose own arXiv page carries exactly that Journal ref and Related DOI. The arXiv page for 2312.14928 carries NO journal ref and NO related DOI (checked 2026-08-12). The venue and DOI are therefore removed. The lesson worth keeping: doi_verified=True recorded that the DOI RESOLVES, not that it resolves to the cited work, so a wrong-target citation passed the flag. Raised 2026-05-11 as D2 1.1, closed only in its title half; found live again in the 2026-08-12 open-critical triage. Original stub note: Verified 2026-05-11 via WebFetch arXiv:2312.14928 (L2/D2 Stage-13 fix-pass). Title corrected from stub-empty to canonical published form. PRD 110:125028 (2024).',
    },
    ...
    'Wen2003': {
        'authors': 'Wen, X.-G.',
        'title': 'Quantum order from string-net condensations and origin of light and massless fermions',
        'journal': 'Physical Review D',
        'volume': 68,
        'page': '065003',
        'year': 2003,
        ...
        'inprep': False,
        'primary_source_path': None,
        'used_in': ['papers/paper3_gauge_erasure/paper_draft.tex', 'papers/D3/paper_draft.tex'],
        'provides': ['String-net condensation as substrate for emergent U(1) gauge field; load-bearing for D3 §4 perturbative Wen-ADW deficit Closure-triad (i).'],
        'notes': 'Verified 2026-05-11 via WebFetch arXiv:hep-th/0302201 (D3 Stage-13 fix-pass). Title corrected from stub-empty to canonical published form; metadata restored from auto-generated stub.',
    },
    ...
    'Zhao2023': {
        ...
        'used_in': ['papers/paper16_graphene_sk_eft/paper_draft.tex',
                    ...
                    'papers/E2/paper_draft.tex'],
        'provides': [],
        'notes': 'Title, full author list, and DOI verified via Nature/PubMed. First author Wenyu Zhao (initial W., not J.). D1 used_in added 2026-05-11 (Stage-13 fix-pass: prior D1 bibitem had wrong first-author initial and wrong paraphrased title `Direct measurement of plasmon-mediated viscosity in graphene`). E2 used_in added 2026-05-11 (Stage-13 reinvocation: E2 bibitem updated to canonical 8-author form).',
    },
    ...
    'alphaproof': {
        ...
        'notes': 'Auto-generated stub from \\bibitem block in `papers/paper15_methodology/paper_draft.tex`. Title not present in source bibitem. '
                 'UNVERIFIABLE BY CONSTRUCTION: a DeepMind blog post with no DOI, no arXiv id and no whitelisted fetch target '
                 '(recorded `fetch_failed` in docs/citation_verifications.jsonl 2026-08-12, NOT verified). '
                 'I1 was retargeted off this key on 2026-08-14 to `AlphaProof2025` — the peer-reviewed Nature article the blog post announced '
                 '(DOI 10.1038/s41586-025-09833-y). `papers/paper15_methodology/` still cites this key; retargeting it is out of I1 Stage-13 scope '
                 'and is filed as residual work.',
    },

    # AlphaProof — the peer-reviewed artifact behind the 2024 silver-medal IMO
    # announcement. Added 2026-08-14 (I1 Stage-13 finding 1.4) to replace the
    # unverifiable `alphaproof` blog-post stub in I1's bibliography.
    # Metadata fetched 2026-08-14 from api.semanticscholar.org (whitelisted
    # scholarly meta) keyed on the DOI; cached at
    # Lit-Search/Phase-1-and-Background/primary-sources/AlphaProof2025.json.
    'AlphaProof2025': {
        'authors': 'Hubert, T., Mehta, R., Sartran, L., Horvath, M. Z., Zuzic, G., Wieser, E., et al. (AlphaProof and AlphaGeometry teams)',
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/AlphaProof2025.json',
        'used_in': ['papers/I1/paper_draft.tex'],
        'provides': [
            'The citable record for the 2024 silver-medal IMO result obtained by reinforcement learning inside Lean; '
            'cited in I1 §1 as an antecedent on the proof-assistance side.'
        ],
        'notes': 'Verified 2026-08-14 via api.semanticscholar.org/graph/v1/paper/DOI:10.1038/s41586-025-09833-y — '
                 'title "Olympiad-level formal mathematical reasoning with reinforcement learning", venue Nature, '
                 'volume 651, pages 607-613, publicationDate 2025-11-12, PubMed 41225005, PMC 12999475. '
                 'This is the peer-reviewed replacement for the `alphaproof` blog-post stub, which has no resolvable identifier.',
    },
    ...
    # ⚠️ FIELD SPLIT 2026-08-14 (I1 Stage-13 finding 1.2). This record used to hold
    # the VENUE in `title` ('Comm.\\ ACM') with the paper title buried inside the
    # `authors` string. Gate 1's content leg compares the REGISTRY title against the
    # cached primary source, so a venue-valued title can never be checked by it.
    'compcert': {
        'authors': 'Leroy, X.',
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-5w/primary-sources/compcert.json',
        'used_in': ['papers/paper15_methodology/paper_draft.tex',
                    'papers/I1/paper_draft.tex'],
        'provides': [],
        'notes': 'Verified 2026-08-14 via api.semanticscholar.org/graph/v1/paper/DOI:10.1145/1538788.1538814 — '
                 'title "Formal verification of a realistic compiler", X. Leroy, Commun. ACM vol. 52, pp. 107-115, 2009, '
                 'DBLP journals/cacm/Leroy09. doi.org resolves to dl.acm.org, which is NOT on the egress whitelist, '
                 'so Semantic Scholar (whitelisted scholarly meta) is the verification pathway of record. '
                 'Was an auto-generated stub from the \\bibitem block in `papers/paper15_methodology/paper_draft.tex` '
                 'with the venue stored in `title`.',
    },
    ...
    'leancipilot': {
        'authors': 'P. Song, K. Yang, A. Anandkumar',
        ...
        'used_in': ['papers/paper15_methodology/paper_draft.tex',
                    'papers/I1/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv:2404.12534 title verified via WebFetch 2026-05-11 (Bundle I1 Stage-13 fix-pass). Authors: Peiyang Song, Kaiyu Yang, Anima Anandkumar.',
    },
    ...
    'physlean': {
        ...
        'provides': [],
        'notes': 'Auto-generated stub from \\bibitem block in `papers/paper14_braided_mtc/paper_draft.tex`. Title not present in source bibitem. '
                 'NOT A PUBLICATION: "PhysLean: Lean 4 for physics" is not a paper title, and PhysLean is the post-rename name of the project '
                 'that was called HepLean in the year (2024) this stub records — the pairing is anachronistic. '
                 'I1 was retargeted off this key on 2026-08-14 (Stage-13 finding 1.1) to `TooBySmithHepLean` — the project paper '
                 '"HepLean: Digitalising high energy physics" (arXiv:2405.08863, Comput. Phys. Commun. 308, 109457) which is already '
                 'registered with verified metadata and a cached PDF. `papers/paper14_braided_mtc/` and `papers/paper15_methodology/` '
                 'still cite this key; retargeting those legacy drafts is out of I1 Stage-13 scope and is filed as residual work.',
    },
    ...
    # ⚠️ FIELD SPLIT 2026-08-14 (I1 Stage-13 finding 1.2) — see the `compcert` note.
    'sel4': {
        'authors': 'Klein, G., Elphinstone, K., Heiser, G., Andronick, J., Cock, D., Derrin, P., et al.',
        'title': 'seL4: formal verification of an OS kernel',
        'journal': 'Proc. ACM SOSP',
        'volume': None,
        'page': '207-220',
        'year': 2009,
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-5w/primary-sources/sel4.json',
        'used_in': ['papers/paper15_methodology/paper_draft.tex',
                    'papers/I1/paper_draft.tex'],
        'provides': [],
        'notes': 'Verified 2026-08-14 via api.semanticscholar.org/graph/v1/paper/DOI:10.1145/1629575.1629596 — '
                 'title "seL4: formal verification of an OS kernel", 13 authors led by Gerwin Klein, '
                 'venue Symposium on Operating Systems Principles (SOSP 2009), pp. 207-220, DBLP conf/sosp/KleinEHACDEEKNSTW09. '
                 'doi.org resolves to dl.acm.org, which is NOT on the egress whitelist, so Semantic Scholar '
                 '(whitelisted scholarly meta) is the verification pathway of record. '
                 'Was an auto-generated stub with the venue stored in `title`.',
    },
    ...
    'Roehm2026D2': {
        ...
        'inprep': True,
        'primary_source_path': None,
        'used_in': ['papers/F/paper_draft.tex', 'papers/L2/paper_draft.tex'],
    ...
    'Roehm2026L2': {
        ...
        'notes': 'In-preparation Bundle L2 self-cite. Canonical bibkey after 2026-05-11 Stage-13 paired-splash rename (was Roehm2026Wave10; alias retained). Phase 7b sub-wave 7b.3 closed at GREEN.',
    },

    # DEPRECATED ALIAS — historically the L2 splash was cited by D2 under the
    # wave-numbered name `Roehm2026Wave10`. Renamed to `Roehm2026L2` in the
    # 2026-05-11 Stage-13 fix-pass to align with the `Roehm2026D2` paired-splash
    # convention. Existing `\cite{Roehm2026Wave10}` in D2 have been swept to
    # `Roehm2026L2`; this alias kept for back-compatibility with any unswept
    # downstream consumer.
    'Roehm2026Wave10': {
        'authors': 'Roehm, J. G.',
        'title': 'Three generations from modular invariance: Spin$^{\\mathbb{Z}_4}$ five-bordism (Bundle L2 PRL splash)',
        ...
        'primary_source_path': None,
        'used_in': [],
        'provides': ['DEPRECATED ALIAS of Roehm2026L2.'],
        'notes': 'DEPRECATED 2026-05-11 — use Roehm2026L2. Same content; retained for back-compat with any external consumer who pinned the wave-numbered name.',
    },
    ...
    'mathlib4_2020': {
        ...
        'volume': None, 'page': '367-381', 'year': 2020,
        'doi': '10.1145/3372885.3373824', 'arxiv': '1910.09336',
        'doi_verified': True, 'arxiv_verified': True,
        'inprep': False,
        'primary_source_path': None,  # textbook-exempt: community-library reference
        'used_in': ['papers/I3/paper_draft.tex'],
        'provides': ['Mathlib library reference (CPP 2020 paper); cited for the Mathlib4 measure-theory + probability infrastructure that I3 builds on.'],
        'notes': 'The Mathlib Community community-library paper, CPP 2020 (DOI 10.1145/3372885.3373824, arXiv:1910.09336). Used in I3 as the canonical citation for the Mathlib library. Added 2026-05-11 (D1 fix-pass missing-from-registry remediation).',
    },
    ...
    # DEPRECATED ALIAS — kept because D3 + F still cite Roehm2026Modular at
    # narrative-level cross-references. Same content as Roehm2026L2.
    'Roehm2026Modular': {
        'authors': 'Roehm, J. G.',
        ...
        'inprep': True,
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex', 'papers/F/paper_draft.tex'],
        ...
        'notes': 'DEPRECATED ALIAS for Roehm2026L2 (= former Roehm2026Wave10). Same content. Phase 7 Stage-13 fix-pass 2026-05-11 elected to leave existing D3+F \\cite{Roehm2026Modular} references in place rather than sweep them; new papers should cite Roehm2026L2.',
    },
    ...
    'CoutantParentani2012': {
        'authors': 'Coutant, A., Parentani, R., Finazzi, S.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D1/paper_draft.tex', 'papers/paper4_wkb_connection/paper_draft.tex'],
        'provides': ['Analytical S-matrix treatment of short-distance-dispersion Hawking radiation.'],
        'notes': 'Crossref-verified 2026-05-11 (D1 Stage-13 fix-pass): actual published title is `Black hole radiation with short distance dispersion, an analytical S-matrix approach`; prior registry title `Hawking radiation with dispersion: the broadened horizon paradigm` was misattributed. Three authors (Coutant, Parentani, Finazzi); prior registry omitted Finazzi.',
    },

    'RobertsonParentani2015': {
        'authors': 'Robertson, S., Parentani, R.',
        'title': 'Hawking radiation in the presence of high-momentum dissipation',
        'journal': 'Physical Review D',
        'volume': 92,
        'page': '044043',
        'year': 2015,
        ...
        'primary_source_path': None,
        'used_in': ['papers/D1/paper_draft.tex', 'papers/paper4_wkb_connection/paper_draft.tex'],
        'provides': ['Analytic dissipative-Hawking results; mode propagation through a high-momentum-dissipating horizon at the WKB level.'],
        'notes': 'Crossref-verified 2026-05-11 (D1 Stage-13 fix-pass): actual published title is `Hawking radiation in the presence of high-momentum DISSIPATION` (not `dispersion: analytical results from cubic dispersion`). Prior registry arXiv 1503.04047 was wrong (math.CO paper); Crossref carries no arXiv for this PRD record. arXiv field set to None pending separate identification.',
    },

    'BelgiornoCacciatori2024': {
        'authors': 'Belgiorno, F. and Cacciatori, S. L. and Trevisan, S.',
    ...
    # ════════════════════════════════════════════════════════════════════
    # Phase 7c — Bundle D3 classical-physics references
    # (Added 2026-05-04 to close D3 Stage-10 r2 BLOCKER 4: bibliography
    # population. Most are pre-arXiv canonical references for which DOI
    # verification was performed via crossref where DOI exists.)
    # ════════════════════════════════════════════════════════════════════

    'ADM1962': {
        'authors': 'Arnowitt, R., Deser, S., Misner, C. W.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['ADM 3+1 decomposition; Hamiltonian formulation of GR'],
        'notes': 'Originally Chapter 7 in "Gravitation: An Introduction to Current Research" (Witten ed., Wiley 1962). Reprinted Gen. Rel. Grav. 40, 1997 (2008) as a Golden Oldie. arXiv:gr-qc/0405109 is the reprint preprint.',
    },
    'Adler1980': {
        'authors': 'Adler, S. L.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Sakharov-Adler induced gravity: order-R term induced from radiative corrections'],
        'notes': 'Pre-arXiv. Pairs with Sakharov1968 as the original Sakharov-Adler induced-gravity references.',
    },
    'Akama1979': {
        'authors': 'Akama, K.',
        'title': 'An attempt at pregeometry: gravity with composite metric',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Pregeometry / induced gravity; metric as fermion-bilinear composite (the "A" in ADW)'],
        'notes': 'Bibkey says 1979; actual publication Dec 1978 in PTP 60(6). Pre-arXiv. Foundational reference for the ADW (Akama-Diakonov-Wetterich) tetrad-bilinear program.',
    },
    'AlmheiriMarolfPolchinskiSully2013': {
        'authors': 'Almheiri, A., Marolf, D., Polchinski, J., Sully, J.',
        ...
        'inprep': False,
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex', 'papers/D4/paper_draft.tex'],
        'provides': ['AMPS firewall paradox; incompatibility of monogamy + unitarity + EFT + equivalence-principle at horizon'],
        'notes': 'JHEP issue 02 (February 2013).',
    },
    'ArnoldMcLerran1987': {
        'authors': 'Arnold, P., McLerran, L.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Electroweak sphaleron rate at finite T; B+L violation rate'],
        'notes': 'Pre-arXiv. Companion to Klinkhamer-Manton 1984 sphaleron solution.',
    },
    'Balbinot2005': {
    ...
    'BardeenCarterHawking1973': {
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Four laws of black hole mechanics: zeroth (uniform kappa), first (dM = (kappa/8pi)dA + ...), second (dA >= 0), third (kappa -> 0 unattainable)'],
        'notes': 'Pre-arXiv. Foundational BCH four-laws paper.',
    },
    'BardeenHillLindner1990': {
        'authors': 'Bardeen, W. A., Hill, C. T., Lindner, M.',
        'title': 'Minimal dynamical symmetry breaking of the standard model',
        'journal': 'Phys. Rev. D',
        'volume': 41,
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['BHL top-quark condensation; dynamical EWSB; m_H ~ 2 m_t leading-order prediction'],
        'notes': 'Pre-arXiv era.',
    },
    'BergesSexty2008': {
        ...
        'page': '306',
        'year': 2008,
        'doi': '10.1016/j.nuclphysb.2008.01.030',
        'arxiv': '0708.0779',
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Stochastic-quantization / complex-Langevin acceleration for lattice gauge theory'],
        'notes': 'D3 §(adw-gap RHMC) originally cited under bibkey "SextyWetterich2009"; verified to be a citation slip — the actual paper is Berges-Sexty 2008, NOT Sexty-Wetterich. Bibkey corrected to BergesSexty2008 in 2026-05-04 r3 fix.',
    },
    'Carter1971': {
        'authors': 'Carter, B.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['No-hair theorem (axisymmetric stationary BH); together with Israel + Robinson establishes Kerr uniqueness'],
        'notes': 'Pre-arXiv.',
    },
    'ChristensenDuff1978': {
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Axial and conformal anomaly coefficients for arbitrary spin; heat-kernel a_2 coefficient input'],
        'notes': 'Pre-arXiv. Used in D3 alongside Vassilevich2003 for heat-kernel calibration of the Sakharov-Adler closure.',
    },
    'CohenKaplanNelson1991': {
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Spontaneous electroweak baryogenesis mechanism; CP-violating chemical potential at the EW phase transition'],
        'notes': 'Pre-arXiv era.',
    },
    'Eddington1919': {
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['1919 solar-eclipse confirmation of GR light deflection prediction (1.75 arcsec at solar limb)'],
        'notes': 'Bibkey "Eddington1919" by convention (eclipse expedition was May 1919); journal publication 1920.',
    },
    'GellMannOakesRenner1968': {
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['GMOR relation: m_pi^2 f_pi^2 = -(m_u + m_d) <q-bar q>; chiral PCAC'],
        'notes': 'Pre-arXiv.',
    },
    'Hawking1971': {
        'authors': 'Hawking, S. W.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Classical area theorem (second law of BH mechanics): horizon area non-decreasing'],
        'notes': 'Pre-arXiv. Original area-theorem PRL.',
    },
    'Hawking1972': {
        'authors': 'Hawking, S. W.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Topology theorem (BH horizon must be S^2); strong rigidity theorem; BH uniqueness chain'],
        'notes': 'Pre-arXiv.',
    },
    'Hawking1975': {
        'authors': 'Hawking, S. W.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Hawking radiation T_H = hbar/(8 pi M); thermal spectrum from BH horizons'],
        'notes': 'Pre-arXiv. Canonical BH-thermodynamics anchor.',
    },
    'HawkingPenrose1970': {
        'authors': 'Hawking, S. W., Penrose, R.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Hawking-Penrose singularity theorem (strong-energy-condition variant)'],
        'notes': 'Pre-arXiv.',
    },
    'Hill2025bilocal': {
        'authors': 'Hill, C. T.',
        'title': 'The nontrivial vacuum structure of an extended t-tbar BEH (Higgs) bound state',
        'journal': 'arXiv',
        'volume': None,
        'page': None,
        'year': 2025,
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Bilocal field-theory correction to BHL top-condensate Higgs-mass prediction'],
        'notes': 'arXiv:2512.16527; submitted Dec 2025; arXiv-only as of cutoff. Best-guess match for D3 §(BHL) "Hill 2025 bilocal" reference based on bilocal+BEH+top-condensate framing.',
    },
    'HughesDrever1960': {
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Hughes-Drever isotropy-of-inertial-mass bound; LLI test'],
        'notes': 'Pre-arXiv. Bibkey "HughesDrever1960" conventionally lumps Hughes-Robinson-Beltran-Lopez 1960 PRL with the companion Drever 1961 Phil. Mag. paper.',
    },
    'Israel1967': {
        'authors': 'Israel, W.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Israel uniqueness theorem (static vacuum BH = Schwarzschild); first leg of no-hair'],
        'notes': 'Pre-arXiv.',
    },
    'Israel1986': {
        'authors': 'Israel, W.',
    ...
    'KehleUnger2024': {
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Smooth one-parameter families of solutions to Einstein-Maxwell-Vlasov interpolating between dispersion and collapse; critical solution = extremal black hole'],
        'notes': 'arXiv:2402.10190 (Feb 2024). Companion 2022 paper (arXiv:2211.15742) gives the explicit third-law disproof; D3 cites the 2024 critical-phenomenon paper.',
    },
    'KlinkhamerManton1984': {
        'authors': 'Klinkhamer, F. R., Manton, N. S.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Electroweak sphaleron saddle-point solution; B+L violation barrier'],
        'notes': 'Pre-arXiv.',
    },
    'LEGEND2024': {
        'authors': 'Acharya, H. et al. (LEGEND Collaboration)',
        ...
        'page': None,
        'year': 2025,
        'doi': '10.48550/arXiv.2505.10440',
        'arxiv': '2505.10440',
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['LEGEND-200 first 0nu beta-beta limit; m_betabeta < 75-200 meV depending on NME; 61.0 kg yr exposure'],
        'notes': 'Bibkey "LEGEND2024" tracks the conference-result year (Neutrino 2024); canonical preprint is arXiv:2505.10440 (May 2025), accepted at PRL with DOI 10.1103/25tk-nctn (volume/page pending publication).',
    },
    'Maldacena1997': {
        'authors': 'Maldacena, J. M.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['AdS/CFT correspondence; gauge/gravity duality'],
        'notes': 'Bibkey "Maldacena1997" tracks the arXiv submission date (Nov 1997); journal publication 1998. Reprinted Int. J. Theor. Phys. 38, 1113 (1999).',
    },
    'MohapatraSenjanovic1980': {
        'authors': 'Mohapatra, R. N., Senjanovic, G.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Type-I seesaw mechanism in left-right symmetric SU(2)_L x SU(2)_R x U(1) gauge theory'],
        'notes': 'Pre-arXiv. The 1981 PRD 23 165 is a longer companion treatment.',
    },
    'PastawskiYoshidaHarlowPreskill2015': {
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex', 'papers/D4/paper_draft.tex'],
        'provides': ['HaPPY codes; holographic QEC toy model; perfect-tensor tilings of hyperbolic space'],
        'notes': 'JHEP issue 06 (June 2015).',
    },
    'Penrose1965': {
        'authors': 'Penrose, R.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Penrose singularity theorem; trapped surfaces imply geodesic incompleteness'],
        'notes': 'Pre-arXiv. Foundational; cited in 2020 Nobel motivation.',
    },
    'PretkoRadzihovsky2018': {
        'authors': 'Pretko, M., Radzihovsky, L.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Fracton-elasticity duality; symmetric tensor gauge theory <-> elasticity of a 2D crystal'],
        'notes': 'D3 §4 fracton diff-invariance no-go anchor.',
    },
    'Robinson1975': {
        'authors': 'Robinson, D. C.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Kerr uniqueness theorem (closes the no-hair chain Israel + Carter + Robinson)'],
        'notes': 'Pre-arXiv.',
    },
    'Sakharov1967': {
        'authors': 'Sakharov, A. D.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Three Sakharov conditions for baryogenesis: B violation, C+CP violation, departure from thermal equilibrium'],
        'notes': 'Pre-arXiv. Originally Pisma Zh. Eksp. Teor. Fiz. 5, 32 (1967). DOI is the 1991 Sov. Phys. Usp. reprint translation.',
    },
    'Sen2013': {
        'authors': 'Sen, A.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Logarithmic correction coefficient -45/2 for non-extremal Schwarzschild BH entropy; disagrees with Kaul-Majumdar -3/2'],
        'notes': 'JHEP issue 04 (April 2013).',
    },
    'Weinberg1989': {
        'authors': 'Weinberg, S.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Canonical statement of the cosmological-constant problem; ~120-order-of-magnitude QFT-vs-observation gap'],
        'notes': 'Pre-arXiv.',
    },
    'Wetterich1990': {
        'authors': 'Wetterich, C.',
        ...
        'page': '693',
        'year': 1990,
        'doi': '10.1007/BF01614701',
        'arxiv': None,
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Wetterich-NJL composite-scalar channel; effective average-action framework underlying the cosmon-NJL line cited in D3 §(BHL)'],
        'notes': 'D3 §(BHL) cites for "Wetterich-NJL scalar channel". Best-match early-1990s composite-Higgs/cosmon-NJL reference. Pre-arXiv.',
    },
    'Wetterich2017': {
        'authors': 'Wetterich, C.',
        ...
        'primary_source_path': None,
        'used_in': ['papers/D3/paper_draft.tex'],
        'provides': ['Updated dilatation-symmetric scaling-solution treatment of cosmology; quintessence from scaling fixed point'],
        'notes': 'arXiv:1711.03844 (Nov 2017). D3 cites as part of the ADW-Wetterich tetrad-bilinear program citation cluster.',
    },
    'Will2014': {
        'authors': 'Will, C. M.',
    ...
    # ════════════════════════════════════════════════════════════════
    # NOTE: Four redundant auto-stub blocks for Roehm2026E1/E2/F were
    # removed 2026-05-11 (D1 Stage-13 fix-pass). The canonical entries
    # for these keys live earlier in the registry (~line 7485+) with
    # full title/used_in metadata; the stub duplicates (empty titles,
    ...
    'YedidiaFreemanWeiss2003': {
        'authors': 'Yedidia, J. S., Freeman, W. T., Weiss, Y.',
        'title': 'Understanding Belief Propagation and Its Generalizations',
        'journal': 'Exploring Artificial Intelligence in the New Millennium (Morgan Kaufmann)',
        'volume': None,
        'page': '239-269',
        'year': 2003,
        'doi': None,
        ...
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6w/primary-sources/YedidiaFreemanWeiss2003.pdf',
        'used_in': ['papers/_phase6w_W2_lean_only/paper_draft.tex',
                    'lean/SKEFTHawking/BeliefPropagation.lean',
                    'papers/D7/paper_draft.tex'],
        'provides': ['Canonical belief-propagation algorithm + Bethe free energy variational principle: fixed points of BP equations are stationary points of the Bethe free energy. Reference for the Wave 6w.2 BP-on-TN substrate (FactorGraph + BPMessages + bpUpdate + IsBPFixedPoint).'],
        'notes': 'Phase 6w Wave 6w.2 BP-on-TN substrate primary reference. Book chapter in *Exploring Artificial Intelligence in the New Millennium* (Lakemeyer + Nebel, eds., Morgan Kaufmann 2003). Identical content also released as MERL Technical Report TR2001-22 (2001; freely available at https://www.merl.com/publications/docs/TR2001-22.pdf — cached as the primary-source PDF). No DOI/arXiv for the book chapter; the MERL TR serves as the canonical primary source.',
    },
    'Zurek1985': {
        'authors': 'Zurek, W. H.',
        ...
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6w/primary-sources/Zurek1985.abstract.txt',
        'used_in': ['papers/_phase6w_W1_lean_only/paper_draft.tex',
                    'lean/SKEFTHawking/KibbleZurekUnruh.lean',
                    'papers/D7/paper_draft.tex'],
        'provides': ['Original proposal of the Kibble-Zurek mechanism (KZM): cosmological symmetry-breaking-defect production tested in superfluid helium. Foundational reference for the universal scaling exponent μ = νz / (1 + νz) that Wave 6w.1 KZM-Unruh bridge formalizes.'],
        'notes': 'Phase 6w Wave 6w.1 foundational KZM reference. Pre-Internet Nature article (1985); publisher PDF is paywalled, so the primary-source cache is the abstract.txt fallback with verbatim Crossref-verified bibliographic metadata + paraphrased KZM physics summary. Crossref DOI 10.1038/317505a0 verified 2026-05-26 (1647 citations).',
    },
    'BiancoResta2011': {
        'authors': 'Bianco, R., Resta, R.',
        ...
        'used_in': ['papers/_phase6w_W5_lean_only/paper_draft.tex',
                    'lean/SKEFTHawking/ChernBridge.lean',
                    'papers/D7/paper_draft.tex'],
        'provides': ['Real-space Chern marker construction: local topological invariant on coordinate-space density matrices via projector commutators. The "real-space Chern marker" of the Wave 6w.5 categorical ↔ real-space Chern bridge theorems is the Bianco-Resta marker (or its tensor-network finite-size approximant per Antão-Sun-Fumega-Lado 2026).'],
        'notes': 'Phase 6w Wave 6w.5 ChernBridge primary reference for the "real-space Chern marker" construction. PRB 84, 241106(R) (2011). DOI verified 2026-05-26 via Crossref (263 citations); arXiv 1106.4014 PDF cached.',
    },
    ...
    # ============================================================
    # D11 / D12 first-lift citations (2026-07-30)
    # ============================================================
    'TKNN1982': {
        'authors': 'Thouless, D. J., Kohmoto, M., Nightingale, M. P., den Nijs, M.',
        'title': 'Quantized Hall Conductance in a Two-Dimensional Periodic Potential',
        'journal': 'Physical Review Letters', 'volume': 49, 'page': '405', 'year': 1982,
        'doi': '10.1103/PhysRevLett.49.405', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6c/primary-sources/TKNN1982.abstract.txt',
    ...
    'Berry1984': {
        ...
        'journal': 'Proceedings of the Royal Society of London A', 'volume': 392, 'page': '45', 'year': 1984,
    ...
    'Haldane1988': {
        ...
        'journal': 'Physical Review Letters', 'volume': 61, 'page': '2015', 'year': 1988,
        'doi': '10.1103/PhysRevLett.61.2015', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6c/primary-sources/Haldane1988.abstract.txt',
        'used_in': ['papers/D11/paper_draft.tex'],
        'provides': ['The honeycomb next-nearest-neighbour complex-hopping model with a nonzero Chern number at zero net flux.'],
        'notes': 'The model whose concrete Chern witness D11 certifies at C = -1 on a 4x4 torus.',
    },
    'FukuiHatsugaiSuzuki2005': {
        'authors': 'Fukui, T., Hatsugai, Y., Suzuki, H.',
        'title': 'Chern Numbers in Discretized Brillouin Zone: Efficient Method of Computing (Spin) Hall Conductances',
        'journal': 'Journal of the Physical Society of Japan', 'volume': 74, 'page': '1674', 'year': 2005,
        'doi': '10.1143/JPSJ.74.1674', 'arxiv': 'cond-mat/0503172',
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6c/primary-sources/FukuiHatsugaiSuzuki2005.abstract.txt',
        'used_in': ['papers/D11/paper_draft.tex'],
        'provides': ['The lattice link-variable/plaquette construction giving a manifestly integer Chern number on a discretized Brillouin zone.'],
        'notes': 'The construction D11 formalizes. Strongest-verified citation in the bundle: arXiv abstract page fetched directly; title, all three authors and journal-ref confirmed.',
    },
    'MaxwellGarnett1904': {
        'authors': 'Maxwell Garnett, J. C.',
        'title': 'XII. Colours in metal glasses and in metallic films',
        'journal': 'Philosophical Transactions of the Royal Society of London A', 'volume': 203, 'page': '385', 'year': 1904,
        'doi': '10.1098/rsta.1904.0024', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6c/primary-sources/MaxwellGarnett1904.abstract.txt',
        'used_in': ['papers/D11/paper_draft.tex'],
        'provides': ['The effective-permittivity mixing rule for a dilute inclusion phase in a host medium.'],
        'notes': 'Origin of the maxwellGarnett formula formalized in 6CE.',
    },
    'Voigt1889': {
        'authors': 'Voigt, W.',
    ...
    'HashinShtrikman1962': {
        ...
        'journal': 'Journal of Applied Physics', 'volume': 33, 'page': '3125', 'year': 1962,
        'doi': '10.1063/1.1728579', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6c/primary-sources/HashinShtrikman1962.abstract.txt',
        'used_in': ['papers/D11/paper_draft.tex'],
        'provides': ['Variational bounds on the effective magnetic permeability / dielectric response of a multiphase composite.'],
        'notes': 'CITE THIS ONE for electromagnetic/permittivity bounds. The 1963 companion is the ELASTIC paper; confusing the two is a common bibliography error.',
    },
    'HashinShtrikman1963': {
        'authors': 'Hashin, Z., Shtrikman, S.',
        'title': 'A variational approach to the theory of the elastic behaviour of multiphase materials',
        'journal': 'Journal of the Mechanics and Physics of Solids', 'volume': 11, 'page': '127', 'year': 1963,
        'doi': '10.1016/0022-5096(63)90060-7', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
    ...
    'HasanKane2010': {
        ...
        'journal': 'Reviews of Modern Physics', 'volume': 82, 'page': '3045', 'year': 2010,
    ...
    'LjungstromMortberg2024': {
        ...
        'journal': 'Mathematical Structures in Computer Science', 'volume': 35, 'page': None, 'year': 2025,
        'doi': None, 'arxiv': '2401.16336',
        'doi_verified': None,
        'inprep': False,
    ...
    'LiPaulson2018': {
        ...
        'journal': None, 'volume': None, 'page': None, 'year': 2018,
        'doi': None, 'arxiv': '1804.03922',
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6c/primary-sources/LiPaulson2018.abstract.txt',
        'used_in': ['papers/D11/paper_draft.tex'],
        'provides': ['Isabelle/HOL winding numbers, Cauchy indices, the argument principle, and a winding-number decision tactic.'],
    ...
    'Kailath1967': {
        ...
        'journal': 'IEEE Transactions on Communication Technology', 'volume': 15, 'page': '52', 'year': 1967,
        'doi': '10.1109/TCOM.1967.1089532', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/Kailath1967.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['The Bhattacharyya-distance bound on the error probability of binary signal discrimination.'],
        'notes': 'Resolvable anchor for the Bhattacharyya bound. Bhattacharyya 1943 (Bull. Calcutta Math. Soc. 35:99) has NO DOI and should be cited only as a historical reference.',
    },
    'LeCam1986': {
        'authors': 'Le Cam, L.',
        'title': 'Asymptotic Methods in Statistical Decision Theory',
        'journal': 'Springer Series in Statistics', 'volume': None, 'page': None, 'year': 1986,
        'doi': '10.1007/978-1-4612-4946-7', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/LeCam1986.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['The two-point testing-affinity lower bound on average error probability underlying the Le Cam floor.'],
        'notes': 'Preferred anchor. The Le Cam 1973 Ann. Statist. alternative (10.1214/aos/1176342380) is UNVERIFIED - Project Euclid was unreachable.',
    },
    'Gabor1946': {
        'authors': 'Gabor, D.',
        'title': 'Theory of Communication',
        'journal': 'Journal of the Institution of Electrical Engineers', 'volume': 93, 'page': '429', 'year': 1946,
        'doi': '10.1049/ji-3-2.1946.0074', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/Gabor1946.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['The classical variance-based time-bandwidth uncertainty product, with equality for Gaussians.'],
        'notes': 'CAUTION, load-bearing: Gabor is the VARIANCE-based product, a DIFFERENT statement from the ENBW*T >= 1/2 filter bound D12 proves. Cite only as the classical antecedent; the ENBW form is proved self-contained from Cauchy-Schwarz. No canonical primary for the ENBW*T form was located.',
    },
    'Irwin1995': {
        'authors': 'Irwin, K. D.',
        'title': 'An application of electrothermal feedback for high resolution cryogenic particle detection',
        'journal': 'Applied Physics Letters', 'volume': 66, 'page': '1998', 'year': 1995,
        'doi': '10.1063/1.113674', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/Irwin1995.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
    ...
    'Mather1982': {
        ...
        'notes': (
            ...
            'ATTRIBUTION (settled 2026-07-31 after three Stage-13 rounds). Cite Mather for the '
            'existence, direction AND approximate magnitude of the reduction. The apparent conflict '
            'with "as much as 30%" was a CONVENTION mismatch, not a disagreement: gamma multiplies '
            'the POWER spectral density, so gamma = 0.4731 at T_b/T_s = 2, n = 4 is a 53% PSD '
            'reduction and a 31% AMPLITUDE reduction. Mather states no convention; read as a maximum '
            'the amplitude reading fits better (max 33% at n=4 vs max 56% PSD), but no stronger '
            'claim is supportable - the closed form attains every PSD reduction in [0,56%], 30% '
            'exactly at r = 1.19. Asymptote is n/(2n+1) = 0.444 at n=4, NOT 1/2, and the '
            'sometimes-quoted F_link band [1/2,1] does not bound this form. Two earlier notes here '
            'were wrong in opposite directions: one claimed the value was corroborated by [1/2,1] '
            'and consistent with 30%; the next claimed Mather did not cover the magnitude at all.'
        ),
    },
    'IrwinHilton2005': {
        'authors': 'Irwin, K. D., Hilton, G. C.',
        'title': 'Transition-Edge Sensors',
        'journal': 'Cryogenic Particle Detection, Topics in Applied Physics', 'volume': 99, 'page': '63', 'year': 2005,
        'doi': '10.1007/10933596_3', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/IrwinHilton2005.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['The standard TES review: electrothermal loop gain, responsivity, thermal and Johnson noise budgets.'],
        'notes': 'Standard review carrying the loop-gain convention L = P_J*alpha/(G*T) that 6EC proves equivalent to its own definition (loopGain_eq_irwinHilton). ⚠️ PROVISIONAL ATTRIBUTION: this project holds this source only as a resolved DOI record and has NOT inspected its text (see the verification record at primary_source_path). Irwin1995, which is read, carries the same convention and is the citation D12 leans on; this entry is attached as the standard review, and D12 §3 says so in the prose rather than trusting it silently.',
    },
    'BlochSiegert1940': {
        'authors': 'Bloch, F., Siegert, A.',
        'title': 'Magnetic Resonance for Nonrotating Fields',
        'journal': 'Physical Review', 'volume': 57, 'page': '522', 'year': 1940,
        'doi': '10.1103/PhysRev.57.522', 'arxiv': None,
        'doi_verified': True,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/BlochSiegert1940.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['The counter-rotating-field correction to magnetic resonance that sets the scale of the rotating-wave error.'],
        'notes': 'DOI resolves to APS; APS returns 403 to automated fetches, so title/pages rest on the resolved DOI plus standard citation.',
    },
    'MeiburgLessaSoldati2025': {
        'authors': 'Meiburg, A., Lessa, L., Soldati, R.',
        'title': "A Formalization of the Generalized Quantum Stein's Lemma in Lean",
        'journal': None, 'volume': None, 'page': None, 'year': 2025,
        'doi': None, 'arxiv': '2510.08672',
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/MeiburgLessaSoldati2025.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['The QuantumInfo half of PhysLib: CPTP/Kraus/Choi machinery, POVMs, trace distance, fidelity, and OptimalHypothesisRate.'],
        'notes': 'MANDATORY CARVE-OUT for D12: quantum hypothesis testing and the CPTP/Kraus/Choi stack are ALREADY formalized here. D12 claims neither.',
    },
    'UnruhCBO2025': {
        'authors': 'Unruh, D., Rodriguez Caballero, J. M.',
        'title': 'Complex Bounded Operators in Isabelle/HOL',
        'journal': None, 'volume': None, 'page': None, 'year': 2025,
        'doi': None, 'arxiv': '2512.05878',
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/UnruhCBO2025.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['Isabelle/HOL complex normed/Banach/Hilbert spaces, adjoints, projectors, the BLT theorem; explicitly NOT trace-class operators or von Neumann algebras.'],
        'notes': "CARVE-OUT: the Isabelle side of the quantum-channel prior art. The companion AFP entry 'Kraus Maps' is UNVERIFIED (isa-afp.org egress-blocked) and must NOT be cited without independent re-verification.",
    },
    'EchenimMhalla2021': {
        'authors': 'Echenim, M., Mhalla, M.',
        'title': 'Quantum Projective Measurements and the CHSH Inequality in Isabelle/HOL',
        'journal': None, 'volume': None, 'page': None, 'year': 2021,
        'doi': None, 'arxiv': '2103.08535',
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/EchenimMhalla2021.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['Isabelle/HOL projective (von Neumann) measurements, observables, outcome probabilities and state collapse; CHSH on arbitrary probability spaces.'],
        'notes': 'CARVE-OUT for measurement formalization. Whether POVMs/channels are covered could NOT be confirmed from the primary - the abstract is terse.',
    },
    'RashidHasan2017': {
        'authors': 'Rashid, A., Hasan, O.',
        'title': 'Formalization of Transform Methods using HOL Light',
        'journal': None, 'volume': None, 'page': None, 'year': 2017,
        'doi': None, 'arxiv': '1705.10050',
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/RashidHasan2017.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['HOL Light Laplace and Fourier transforms for transfer-function and frequency-response analysis of continuous-time systems.'],
        'notes': 'CARVE-OUT for D12 signal-processing novelty: transform methods and transfer-function algebra ARE formalized; the stochastic noise-metrology layer above them is not. The abstract mentions no noise, bandwidth, matched filter or detection.',
    },
    'Degenne2025Kernels': {
        'authors': 'Degenne, R.',
        'title': "Markov kernels in Mathlib's probability library",
        ...
        'doi_verified': None,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/Degenne2025Kernels.abstract.txt',
        'used_in': ['papers/D12/paper_draft.tex'],
        'provides': ['Context for Mathlib probability/information theory: entropy and Kullback-Leibler divergence, without Hellinger, Renyi, total-variation or testing bounds.'],
        'notes': 'Cited for honest scoping of what Mathlib DOES carry. The out-of-Mathlib project RemyDegenne/testing-lower-bounds is a BLOCKING pre-submission prior-art check for D12 and is deliberately NOT cited as established prior art.',
    },
    ...
    'Audenaert2007': {
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Audenaert2007.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/0610146 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'BB84': {
        'authors': 'C.~H. Bennett and G.~Brassard',
    ...
    'BBPSSW1996': {
        'authors': 'C.~H. Bennett, G.~Brassard, S.~Popescu, B.~Schumacher, J.~A. Smolin, and W.~K. Wootters',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/BBPSSW1996.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9511027 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'BDCZ1998': {
        'authors': 'H.-J. Briegel, W.~D\\"ur, J.~I. Cirac, and P.~Zoller',
        ...
        'year': 1998,
        'doi': None,
        'arxiv': 'quant-ph/9803056',
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/BDCZ1998.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9803056 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'BennettDiVincenzoSmolin1997': {
        'authors': 'C.~H. Bennett, D.~P. DiVincenzo, and J.~A. Smolin',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/BennettDiVincenzoSmolin1997.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9701015 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'CalsamigliaLutkenhaus2001': {
        'authors': 'J.~Calsamiglia and N.~L\\"utkenhaus',
        ...
        'year': 2001,
        'doi': None,
        'arxiv': 'quant-ph/0007058',
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/CalsamigliaLutkenhaus2001.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/0007058 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'Chung2025': {
        'authors': 'K.~Chung, M.~Hajdu\\v{s}ek, R.~Van~Meter',
        'title': 'Cross-verification of quantum network simulators',
        'journal': None,
        'volume': None,
        'page': None,
        'year': 2025,
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Chung2025.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint 2504.01290 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'DEJMPS1996': {
        'authors': 'D.~Deutsch, A.~Ekert, R.~Jozsa, C.~Macchiavello, S.~Popescu, and A.~Sanpera',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/DEJMPS1996.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9604039 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'FortescueLo2007': {
        'authors': 'B.~Fortescue and H.-K. Lo',
        ...
        'year': 2007,
        'doi': None,
        'arxiv': 'quant-ph/0607126',
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/FortescueLo2007.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/0607126 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'FuchsvandeGraaf1999': {
        'authors': 'C.~A. Fuchs and J.~van~de~Graaf',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/FuchsvandeGraaf1999.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9712042 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'Gambetta2007': {
        'authors': 'J.~Gambetta, W.~A. Braff, A.~Wallraff, S.~M. Girvin, and R.~J. Schoelkopf',
        ...
        'year': 2007,
        'doi': None,
        'arxiv': 'cond-mat/0701078',
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Gambetta2007.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint cond-mat/0701078 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'Geerlings2013': {
        'authors': 'K.~Geerlings, Z.~Leghtas, I.~M. Pop, S.~Shankar, L.~Frunzio, R.~J. Schoelkopf, M.~Mirrahimi, and M.~H. Devoret',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Geerlings2013.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint 1211.0491 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'Horodecki1999': {
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Horodecki1999.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9807091 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'HorodeckiPPT1996': {
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/HorodeckiPPT1996.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9605038 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'Jin2015': {
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Jin2015.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint 1412.2772 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'Macchiavello1998': {
        'authors': 'C.~Macchiavello',
        'title': 'On the analytical convergence of the QPA procedure',
        'journal': 'Phys. Lett. A',
        'volume': 246,
        'page': None,
        'year': 1998,
        'doi': None,
        'arxiv': 'quant-ph/9807074',
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Macchiavello1998.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9807074 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'Magesan2011': {
        'authors': 'E.~Magesan, J.~M. Gambetta, and J.~Emerson',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Magesan2011.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint 1009.3639 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'MassarPopescu1995': {
        'authors': 'S.~Massar and S.~Popescu',
    ...
    'Nielsen2002': {
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Nielsen2002.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/0205035 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'PLOB2017': {
        'authors': 'S.~Pirandola, R.~Laurenza, C.~Ottaviani, and L.~Banchi',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/PLOB2017.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint 1510.08863 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'Peres1996': {
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Peres1996.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/9604005 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'Plenio2005': {
        ...
        'year': 2005,
        'doi': None,
        'arxiv': 'quant-ph/0505071',
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Plenio2005.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/0505071 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'Sangouard2011': {
        'authors': 'N.~Sangouard, C.~Simon, H.~de~Riedmatten, and N.~Gisin',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Sangouard2011.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint 0906.2699 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'ShorPreskill2000': {
        'authors': 'P.~W. Shor and J.~Preskill',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/ShorPreskill2000.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/0003004 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    'VidalWerner2002': {
        'authors': 'G.~Vidal and R.~F. Werner',
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/VidalWerner2002.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint quant-ph/0102117 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },

    'Walter2017': {
        'authors': "T.~Walter, P.~Kurpiers, S.~Gasparinetti, P.~Magnard, A.~Poto\\v{c}nik, Y.~Salath\\'e, M.~Pechal, M.~Mondal, M.~Oppliger, C.~Eichler, and A.~Wallraff",
        ...
        'doi_verified': False,
        'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-1-and-Background/primary-sources/Walter2017.pdf',
        'used_in': ['papers/D9/paper_draft.tex'],
        'provides': [],
        'notes': 'arXiv preprint 1701.06933 (id title-matched against the arXiv API 2026-06-10). PDF cached as primary source.',
    },
    ...
    # ════════════════════════════════════════════════════════════════
    # D10 — Computational quantum chemistry & open-system foundations
    # (Phases 6BA/6BB/6BC first-lift, 2026-06-30). Canonical textbooks +
    # classic primaries + ITP-ecosystem refs; all textbook/exempt path
    # (no local PDF cache — canonical, or off the egress whitelist with
    # arXiv ID + authors verified by the D10 Stage-13 adversarial review).
    # ════════════════════════════════════════════════════════════════
    ...
    'survey2021': {
        'authors': 'Lewis, M., Soudjani, S., Zuliani, P.',
        'title': 'Formal Verification of Quantum Programs: Theory, Tools and Challenges',
        'journal': 'arXiv', 'volume': None, 'page': None, 'year': 2021,
    ...
    'coqq2022': {
        ...
        # Published at POPL 2023 (Proc. ACM Program. Lang.); the DOI below is the ACM one,
        # so `journal: 'arXiv'` contradicted the entry's own DOI and its primary-source
        # cache header. Caught 2026-08-14 by the Venue leg of
        # `citation_primary_sources_present` (D11 round-4 finding 1.1 / round-8 1.1).
        'journal': 'Proc. ACM Program. Lang.', 'volume': None, 'page': None, 'year': 2022,
        'doi': '10.1145/3571222', 'arxiv': '2207.11350', 'doi_verified': True, 'inprep': False,
        'primary_source_path': 'Lit-Search/Phase-6e/primary-sources/coqq2022.abstract.txt',
    ...
    'leanQI2025': {
        'authors': 'Meiburg, A., Lessa, L. A., Soldati, R. R.',
        'title': "A Formalization of the Generalized Quantum Stein's Lemma in Lean",
        'journal': 'arXiv', 'volume': None, 'page': None, 'year': 2025,
        'doi': None, 'arxiv': None, 'doi_verified': False, 'inprep': False,
        'primary_source_path': None,
        'used_in': ['papers/D10/paper_draft.tex'], 'provides': [],
